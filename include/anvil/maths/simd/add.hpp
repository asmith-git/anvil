...
//};
//
//std::ofstream file("_simd.hpp");
//
//for (const char* t : types) {
//	for (int s : sizes) {
//		file << "static ANVIL_STRONG_INLINE _simd_" << t << "x" << s << " ANVIL_SIMD_CALL _simd_" << t << "x" << s << "_add(" << "const register _simd_" << t << "x" << s << ", const register _simd_" << t << "x" << s << " y) {" << std::endl;
//		file << "#ifdef _simd_" << t << "x" << s << "_add_" << std::endl;
//		file << "\treturn _simd_" << t << "x" << s << "_add_(x, y);" << std::endl;
//		for (int s2 : sizes) {
//			if (s2 <= s) continue;
//			file << "#else _simd_" << t << "x" << s2 << "_add_" << std::endl;
//			file << "\tunion SIMDUnion { _simd_" << t << "x" << s << " v1; _simd_" << t << "x" << s2 << " v2; };" << std::endl;
//			file << "\tSIMDUnion x, y;" << std::endl;
//			file << "\tx_.v1 = x;" << std::endl;
//			file << "\ty_.v1 = y;" << std::endl;
//			file << "\tx_.v2 = _simd_" << t << "x" << s2 << "_add_(x_.v2, y_.v2);" << std::endl;
//			file << "\treturn x_.v1;" << std::endl;
//		}
//		file << "#else" << std::endl;
//		if (s > 2) {
//			int s2 = s / 2;
//			file << "\treturn _simd_" << t << "x" << s << "_combine(" << std::endl;
//			file << "\t\t_simd_" << t << "x" << s2 << "_add(_simd_" << t << "x" << s << "_splitlo(x), _simd_" << t << "x" << s << "_splitlo(y))," << std::endl;
//			file << "\t\t_simd_" << t << "x" << s2 << "_add(_simd_" << t << "x" << s << "_splithi(x), _simd_" << t << "x" << s << "_splithi(y)));" << std::endl;
//		}else {
//			file << "\treturn _simd_" << t << "x" << s << "_add_safe(x, y);" << std::endl;
//		}
//		file << "#endif" << std::endl;
//		file << "}" << std::endl;
//		file << "#ifndef _simd_" << t << "x" << s << "_add_enable" << std::endl;
//		file << "\t#define _simd_" << t << "x" << s << "_add_enable() true" << std::endl;
//		file << "#endif" << std::endl;
//		file << std::endl;
//	}
//}
...
#ifndef _simd_f64x4_add_enable
	#define _simd_f64x4_add_enable() true
#endif
...
#ifndef _simd_f64x8_add_enable
	#define _simd_f64x8_add_enable() true
#endif
...
#ifndef _simd_f64x16_add_enable
	#define _simd_f64x16_add_enable() true
#endif
...
#ifndef _simd_f64x32_add_enable
	#define _simd_f64x32_add_enable() true
#endif
...
#ifndef _simd_f64x64_add_enable
	#define _simd_f64x64_add_enable() true
#endif
...
#ifndef _simd_f32x4_add_enable
	#define _simd_f32x4_add_enable() true
#endif
...
#ifndef _simd_f32x8_add_enable
	#define _simd_f32x8_add_enable() true
#endif
...
#ifndef _simd_f32x16_add_enable
	#define _simd_f32x16_add_enable() true
#endif
...
#ifndef _simd_f32x32_add_enable
	#define _simd_f32x32_add_enable() true
#endif
...
#ifndef _simd_f32x64_add_enable
	#define _simd_f32x64_add_enable() true
#endif
...
#ifndef _simd_s64x4_add_enable
	#define _simd_s64x4_add_enable() true
#endif
...
#ifndef _simd_s64x8_add_enable
	#define _simd_s64x8_add_enable() true
#endif
...
#ifndef _simd_s64x16_add_enable
	#define _simd_s64x16_add_enable() true
#endif
...
#ifndef _simd_s64x32_add_enable
	#define _simd_s64x32_add_enable() true
#endif
...
#ifndef _simd_s64x64_add_enable
	#define _simd_s64x64_add_enable() true
#endif
...
#ifndef _simd_u64x4_add_enable
	#define _simd_u64x4_add_enable() true
#endif
...
#ifndef _simd_u64x8_add_enable
	#define _simd_u64x8_add_enable() true
#endif
...
#ifndef _simd_u64x16_add_enable
	#define _simd_u64x16_add_enable() true
#endif
...
#ifndef _simd_u64x32_add_enable
	#define _simd_u64x32_add_enable() true
#endif
...
#ifndef _simd_u64x64_add_enable
	#define _simd_u64x64_add_enable() true
#endif
...
#ifndef _simd_s32x4_add_enable
	#define _simd_s32x4_add_enable() true
#endif
...
#ifndef _simd_s32x8_add_enable
	#define _simd_s32x8_add_enable() true
#endif
...
#ifndef _simd_s32x16_add_enable
	#define _simd_s32x16_add_enable() true
#endif
...
#ifndef _simd_s32x32_add_enable
	#define _simd_s32x32_add_enable() true
#endif
...
#ifndef _simd_s32x64_add_enable
	#define _simd_s32x64_add_enable() true
#endif
...
#ifndef _simd_u32x4_add_enable
	#define _simd_u32x4_add_enable() true
#endif
...
#ifndef _simd_u32x8_add_enable
	#define _simd_u32x8_add_enable() true
#endif
...
#ifndef _simd_u32x16_add_enable
	#define _simd_u32x16_add_enable() true
#endif
...
#ifndef _simd_u32x32_add_enable
	#define _simd_u32x32_add_enable() true
#endif
...
#ifndef _simd_u32x64_add_enable
	#define _simd_u32x64_add_enable() true
#endif
...
#ifndef _simd_s16x4_add_enable
	#define _simd_s16x4_add_enable() true
#endif
...
#ifndef _simd_s16x8_add_enable
	#define _simd_s16x8_add_enable() true
#endif
...
#ifndef _simd_s16x16_add_enable
	#define _simd_s16x16_add_enable() true
#endif
...
#ifndef _simd_s16x32_add_enable
	#define _simd_s16x32_add_enable() true
#endif
...
#ifndef _simd_s16x64_add_enable
	#define _simd_s16x64_add_enable() true
#endif
...
#ifndef _simd_u16x4_add_enable
	#define _simd_u16x4_add_enable() true
#endif
...
#ifndef _simd_u16x8_add_enable
	#define _simd_u16x8_add_enable() true
#endif
...
#ifndef _simd_u16x16_add_enable
	#define _simd_u16x16_add_enable() true
#endif
...
#ifndef _simd_u16x32_add_enable
	#define _simd_u16x32_add_enable() true
#endif
...
#ifndef _simd_u16x64_add_enable
	#define _simd_u16x64_add_enable() true
#endif
...
#ifndef _simd_s8x4_add_enable
	#define _simd_s8x4_add_enable() true
#endif
...
#ifndef _simd_s8x8_add_enable
	#define _simd_s8x8_add_enable() true
#endif
...
#ifndef _simd_s8x16_add_enable
	#define _simd_s8x16_add_enable() true
#endif
...
#ifndef _simd_s8x32_add_enable
	#define _simd_s8x32_add_enable() true
#endif
...
#ifndef _simd_s8x64_add_enable
	#define _simd_s8x64_add_enable() true
#endif
...
#ifndef _simd_u8x4_add_enable
	#define _simd_u8x4_add_enable() true
#endif
...
#ifndef _simd_u8x8_add_enable
	#define _simd_u8x8_add_enable() true
#endif
...
#ifndef _simd_u8x16_add_enable
	#define _simd_u8x16_add_enable() true
#endif
...
#ifndef _simd_u8x32_add_enable
	#define _simd_u8x32_add_enable() true
#endif
...
#ifndef _simd_u8x64_add_enable
	#define _simd_u8x64_add_enable() true
#endif
