...
//limitations under the License.
	...
	#define _simd_f64x1_cmplt_safe(X,Y) static_cast<f64x1>(X < Y)
...
#define _simd_f64x64_cmplt_safe(X,Y)_simd_f64x64_combine_safe(\
	...
	#define _simd_f32x1_cmplt_safe(X,Y) static_cast<f32x1>(X < Y)
...
#define _simd_f32x64_cmplt_safe(X,Y)_simd_f32x64_combine_safe(\
	...
	#define _simd_s64x1_cmplt_safe(X,Y) static_cast<s64x1>(X < Y)
...
#define _simd_s64x64_cmplt_safe(X,Y)_simd_s64x64_combine_safe(\
	...
	#define _simd_u64x1_cmplt_safe(X,Y) static_cast<u64x1>(X < Y)
...
#define _simd_u64x64_cmplt_safe(X,Y)_simd_u64x64_combine_safe(\
	...
	#define _simd_s32x1_cmplt_safe(X,Y) static_cast<s32x1>(X < Y)
...
#define _simd_s32x64_cmplt_safe(X,Y)_simd_s32x64_combine_safe(\
	...
	#define _simd_u32x1_cmplt_safe(X,Y) static_cast<u32x1>(X < Y)
...
#define _simd_u32x64_cmplt_safe(X,Y)_simd_u32x64_combine_safe(\
	...
	#define _simd_s16x1_cmplt_safe(X,Y) static_cast<s16x1>(X < Y)
...
#define _simd_s16x64_cmplt_safe(X,Y)_simd_s16x64_combine_safe(\
	...
	#define _simd_u16x1_cmplt_safe(X,Y) static_cast<u16x1>(X < Y)
...
#define _simd_u16x64_cmplt_safe(X,Y)_simd_u16x64_combine_safe(\
	...
	#define _simd_s8x1_cmplt_safe(X,Y) static_cast<s8x1>(X < Y)
...
#define _simd_s8x64_cmplt_safe(X,Y)_simd_s8x64_combine_safe(\
	...
	#define _simd_u8x1_cmplt_safe(X,Y) static_cast<u8x1>(X < Y)
