...
#define _simd_f64x1_xor_safe(X,Y) (x ^ y)
...
#else
	#define _simd_f64x2_xor_(X,Y) _simd_f64x2_combine(\
...
#else
	#define _simd_f64x4_xor_(X,Y) _simd_f64x4_combine(\
...
#else
	#define _simd_f64x8_xor_(X,Y) _simd_f64x8_combine(\
...
#else
	#define _simd_f64x16_xor_(X,Y) _simd_f64x16_combine(\
...
#else
	#define _simd_f64x32_xor_(X,Y) _simd_f64x32_combine(\
...
#else
	#define _simd_f64x64_xor_(X,Y) _simd_f64x64_combine(\
...
#define _simd_f32x1_xor_safe(X,Y) (x ^ y)
...
#else
	#define _simd_f32x2_xor_(X,Y) _simd_f32x2_combine(\
...
#else
	#define _simd_f32x4_xor_(X,Y) _simd_f32x4_combine(\
...
#else
	#define _simd_f32x8_xor_(X,Y) _simd_f32x8_combine(\
...
#else
	#define _simd_f32x16_xor_(X,Y) _simd_f32x16_combine(\
...
#else
	#define _simd_f32x32_xor_(X,Y) _simd_f32x32_combine(\
...
#else
	#define _simd_f32x64_xor_(X,Y) _simd_f32x64_combine(\
...
#else
	#define _simd_s64x2_xor_(X,Y) _simd_s64x2_combine(\
...
#else
	#define _simd_s64x4_xor_(X,Y) _simd_s64x4_combine(\
...
#else
	#define _simd_s64x8_xor_(X,Y) _simd_s64x8_combine(\
...
#else
	#define _simd_s64x16_xor_(X,Y) _simd_s64x16_combine(\
...
#else
	#define _simd_s64x32_xor_(X,Y) _simd_s64x32_combine(\
...
#else
	#define _simd_s64x64_xor_(X,Y) _simd_s64x64_combine(\
...
#else
	#define _simd_u64x2_xor_(X,Y) _simd_u64x2_combine(\
...
#else
	#define _simd_u64x4_xor_(X,Y) _simd_u64x4_combine(\
...
#else
	#define _simd_u64x8_xor_(X,Y) _simd_u64x8_combine(\
...
#else
	#define _simd_u64x16_xor_(X,Y) _simd_u64x16_combine(\
...
#else
	#define _simd_u64x32_xor_(X,Y) _simd_u64x32_combine(\
...
#else
	#define _simd_u64x64_xor_(X,Y) _simd_u64x64_combine(\
...
#else
	#define _simd_s32x2_xor_(X,Y) _simd_s32x2_combine(\
...
#else
	#define _simd_s32x4_xor_(X,Y) _simd_s32x4_combine(\
...
#else
	#define _simd_s32x8_xor_(X,Y) _simd_s32x8_combine(\
...
#else
	#define _simd_s32x16_xor_(X,Y) _simd_s32x16_combine(\
...
#else
	#define _simd_s32x32_xor_(X,Y) _simd_s32x32_combine(\
...
#else
	#define _simd_s32x64_xor_(X,Y) _simd_s32x64_combine(\
...
#else
	#define _simd_u32x2_xor_(X,Y) _simd_u32x2_combine(\
...
#else
	#define _simd_u32x4_xor_(X,Y) _simd_u32x4_combine(\
...
#else
	#define _simd_u32x8_xor_(X,Y) _simd_u32x8_combine(\
...
#else
	#define _simd_u32x16_xor_(X,Y) _simd_u32x16_combine(\
...
#else
	#define _simd_u32x32_xor_(X,Y) _simd_u32x32_combine(\
...
#else
	#define _simd_u32x64_xor_(X,Y) _simd_u32x64_combine(\
...
#else
	#define _simd_s16x2_xor_(X,Y) _simd_s16x2_combine(\
...
#else
	#define _simd_s16x4_xor_(X,Y) _simd_s16x4_combine(\
...
#else
	#define _simd_s16x8_xor_(X,Y) _simd_s16x8_combine(\
...
#else
	#define _simd_s16x16_xor_(X,Y) _simd_s16x16_combine(\
...
#else
	#define _simd_s16x32_xor_(X,Y) _simd_s16x32_combine(\
...
#else
	#define _simd_s16x64_xor_(X,Y) _simd_s16x64_combine(\
...
#else
	#define _simd_u16x2_xor_(X,Y) _simd_u16x2_combine(\
...
#else
	#define _simd_u16x4_xor_(X,Y) _simd_u16x4_combine(\
...
#else
	#define _simd_u16x8_xor_(X,Y) _simd_u16x8_combine(\
...
#else
	#define _simd_u16x16_xor_(X,Y) _simd_u16x16_combine(\
...
#else
	#define _simd_u16x32_xor_(X,Y) _simd_u16x32_combine(\
...
#else
	#define _simd_u16x64_xor_(X,Y) _simd_u16x64_combine(\
...
#else
	#define _simd_s8x2_xor_(X,Y) _simd_s8x2_combine(\
...
#else
	#define _simd_s8x4_xor_(X,Y) _simd_s8x4_combine(\
...
#else
	#define _simd_s8x8_xor_(X,Y) _simd_s8x8_combine(\
...
#else
	#define _simd_s8x16_xor_(X,Y) _simd_s8x16_combine(\
...
#else
	#define _simd_s8x32_xor_(X,Y) _simd_s8x32_combine(\
...
#else
	#define _simd_s8x64_xor_(X,Y) _simd_s8x64_combine(\
...
#else
	#define _simd_u8x2_xor_(X,Y) _simd_u8x2_combine(\
...
#else
	#define _simd_u8x4_xor_(X,Y) _simd_u8x4_combine(\
...
#else
	#define _simd_u8x8_xor_(X,Y) _simd_u8x8_combine(\
...
#else
	#define _simd_u8x16_xor_(X,Y) _simd_u8x16_combine(\
...
#else
	#define _simd_u8x32_xor_(X,Y) _simd_u8x32_combine(\
...
#else
	#define _simd_u8x64_xor_(X,Y) _simd_u8x64_combine(\
