...
#define _simd_f64x1_add_(X,Y) (x + y)
#define _simd_f64x1_add_instruction_set(X) anvil::simd::IS_NONE
#define _simd_f64x1_sub_(X,Y) (x - y)
#define _simd_f64x1_sub_instruction_set(X) anvil::simd::IS_NONE
#define _simd_f64x1_mul_(X,Y) (x * y)
#define _simd_f64x1_mul_instruction_set(X) anvil::simd::IS_NONE
#define _simd_f64x1_div_(X,Y) (x / y)
#define _simd_f64x1_div_instruction_set(X) anvil::simd::IS_NONE
#define _simd_f32x1_add_(X,Y) (x + y)
#define _simd_f32x1_add_instruction_set(X) anvil::simd::IS_NONE
#define _simd_f32x1_sub_(X,Y) (x - y)
#define _simd_f32x1_sub_instruction_set(X) anvil::simd::IS_NONE
#define _simd_f32x1_mul_(X,Y) (x * y)
#define _simd_f32x1_mul_instruction_set(X) anvil::simd::IS_NONE
#define _simd_f32x1_div_(X,Y) (x / y)
#define _simd_f32x1_div_instruction_set(X) anvil::simd::IS_NONE
#define _simd_s64x1_add_(X,Y) (x + y)
#define _simd_s64x1_add_instruction_set(X) anvil::simd::IS_NONE
#define _simd_s64x1_sub_(X,Y) (x - y)
#define _simd_s64x1_sub_instruction_set(X) anvil::simd::IS_NONE
#define _simd_s64x1_mul_(X,Y) (x * y)
#define _simd_s64x1_mul_instruction_set(X) anvil::simd::IS_NONE
#define _simd_s64x1_div_(X,Y) (x / y)
#define _simd_s64x1_div_instruction_set(X) anvil::simd::IS_NONE
#define _simd_u64x1_add_(X,Y) (x + y)
#define _simd_u64x1_add_instruction_set(X) anvil::simd::IS_NONE
#define _simd_u64x1_sub_(X,Y) (x - y)
#define _simd_u64x1_sub_instruction_set(X) anvil::simd::IS_NONE
#define _simd_u64x1_mul_(X,Y) (x * y)
#define _simd_u64x1_mul_instruction_set(X) anvil::simd::IS_NONE
#define _simd_u64x1_div_(X,Y) (x / y)
#define _simd_u64x1_div_instruction_set(X) anvil::simd::IS_NONE
#define _simd_s32x1_add_(X,Y) (x + y)
#define _simd_s32x1_add_instruction_set(X) anvil::simd::IS_NONE
#define _simd_s32x1_sub_(X,Y) (x - y)
#define _simd_s32x1_sub_instruction_set(X) anvil::simd::IS_NONE
#define _simd_s32x1_mul_(X,Y) (x * y)
#define _simd_s32x1_mul_instruction_set(X) anvil::simd::IS_NONE
#define _simd_s32x1_div_(X,Y) (x / y)
#define _simd_s32x1_div_instruction_set(X) anvil::simd::IS_NONE
#define _simd_u32x1_add_(X,Y) (x + y)
#define _simd_u32x1_add_instruction_set(X) anvil::simd::IS_NONE
#define _simd_u32x1_sub_(X,Y) (x - y)
#define _simd_u32x1_sub_instruction_set(X) anvil::simd::IS_NONE
#define _simd_u32x1_mul_(X,Y) (x * y)
#define _simd_u32x1_mul_instruction_set(X) anvil::simd::IS_NONE
#define _simd_u32x1_div_(X,Y) (x / y)
#define _simd_u32x1_div_instruction_set(X) anvil::simd::IS_NONE
#define _simd_s16x1_add_(X,Y) (x + y)
#define _simd_s16x1_add_instruction_set(X) anvil::simd::IS_NONE
#define _simd_s16x1_sub_(X,Y) (x - y)
#define _simd_s16x1_sub_instruction_set(X) anvil::simd::IS_NONE
#define _simd_s16x1_mul_(X,Y) (x * y)
#define _simd_s16x1_mul_instruction_set(X) anvil::simd::IS_NONE
#define _simd_s16x1_div_(X,Y) (x / y)
#define _simd_s16x1_div_instruction_set(X) anvil::simd::IS_NONE
#define _simd_u16x1_add_(X,Y) (x + y)
#define _simd_u16x1_add_instruction_set(X) anvil::simd::IS_NONE
#define _simd_u16x1_sub_(X,Y) (x - y)
#define _simd_u16x1_sub_instruction_set(X) anvil::simd::IS_NONE
#define _simd_u16x1_mul_(X,Y) (x * y)
#define _simd_u16x1_mul_instruction_set(X) anvil::simd::IS_NONE
#define _simd_u16x1_div_(X,Y) (x / y)
#define _simd_u16x1_div_instruction_set(X) anvil::simd::IS_NONE
#define _simd_s8x1_add_(X,Y) (x + y)
#define _simd_s8x1_add_instruction_set(X) anvil::simd::IS_NONE
#define _simd_s8x1_sub_(X,Y) (x - y)
#define _simd_s8x1_sub_instruction_set(X) anvil::simd::IS_NONE
#define _simd_s8x1_mul_(X,Y) (x * y)
#define _simd_s8x1_mul_instruction_set(X) anvil::simd::IS_NONE
#define _simd_s8x1_div_(X,Y) (x / y)
#define _simd_s8x1_div_instruction_set(X) anvil::simd::IS_NONE
#define _simd_u8x1_add_(X,Y) (x + y)
#define _simd_u8x1_add_instruction_set(X) anvil::simd::IS_NONE
#define _simd_u8x1_sub_(X,Y) (x - y)
#define _simd_u8x1_sub_instruction_set(X) anvil::simd::IS_NONE
#define _simd_u8x1_mul_(X,Y) (x * y)
#define _simd_u8x1_mul_instruction_set(X) anvil::simd::IS_NONE
#define _simd_u8x1_div_(X,Y) (x / y)
#define _simd_u8x1_div_instruction_set(X) anvil::simd::IS_NONE
...
#define ANVIL_SIMD_IMPLEMENTATION_S_S_1_SPECIALISE(O,T,F)\
	...
	template<class T, size_t S>
	struct OperationImplementation<T, S, OP_SHUFF, false> {
...
#define ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,OP_SIZE,SIZE,INSTRUCTION,FUNCTION1)\
	template<>\
	struct OperationImplementation<_simd_element_type, SIZE, OP, true> {\
		...
		static ANVIL_STRONG_INLINE _simd_type ANVIL_SIMD_CALL execute(const register simd_t x, const register simd_t y, const register simd_t z) {\
		...
		static ANVIL_STRONG_INLINE void ANVIL_SIMD_CALL execute(const register _simd_element_type* x, const register _simd_element_type* y, const register _simd_element_type* z, _simd_element_type* o) {\
			helper_t::get<SIZE>(execute(helper_t::setn<SIZE>(x),helper_t::setn<SIZE>(y), helper_t::setn<SIZE>(z)),o);\
		}\
	};
...
#define ANVIL_SIMD_IMPLEMENTATION_V_VVV_16_TO_32(OP,INSTRUCTION, FUNCTION1)\
	...
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,32,29,INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,32,28,INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,32,27,INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,32,26,INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,32,25, INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,32,24, INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,32,23, INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,32,22, INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,32,21, INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,32,20, INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,32,19,INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,32,18,INSTRUCTION, FUNCTION1)\
...
#define ANVIL_SIMD_IMPLEMENTATION_V_VVV_8_TO_16(OP,INSTRUCTION, FUNCTION1)\
	...
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,16,13,INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,16,12,INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,16,11,INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,16,10,INSTRUCTION, FUNCTION1)\
...
#define ANVIL_SIMD_IMPLEMENTATION_V_VVV_16(OP,INSTRUCTION, FUNCTION1)\
	...
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,16,10,INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,16,9, INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,16,8, INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,16,7, INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,16,6, INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,16,5, INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,16,4, INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,16,3, INSTRUCTION, FUNCTION1)\
...
#define ANVIL_SIMD_IMPLEMENTATION_V_VVV_8(OP,INSTRUCTION, FUNCTION1)\
	...
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,8,6,INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,8,5,INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,8,4,INSTRUCTION, FUNCTION1)\
	ANVIL_SIMD_IMPLEMENTATION_V_VVV(OP,8,3,INSTRUCTION, FUNCTION1)\
...
static ANVIL_STRONG_INLINE __m128 ANVIL_SIMD_CALL _simd_shuffle_ps(const register __m128 x) {
	return _mm_shuffle_ps(x, x, _MM_SHUFFLE(X, Y, Z, W));
}

template<int X, int Y, int Z, int W>
static ANVIL_STRONG_INLINE __m128i ANVIL_SIMD_CALL _simd_shuffle_epi32(const register __m128i x) {
	return _mm_shuffle_epi32(x, x, _MM_SHUFFLE(X, Y, Z, W));
}
...
#define _simd_type __m128
	...
	ANVIL_SIMD_IMPLEMENTATION_V_VVV_4( OP_FMA,   FMA,     _mm_fmadd_ps)   
	ANVIL_SIMD_IMPLEMENTATION_V_VVV_4( OP_FMS,   FMA,     _mm_fmsub_ps)  
...
#define _simd_type __m256
	...
	ANVIL_SIMD_IMPLEMENTATION_V_VVV_4_TO_8( OP_FMA,   FMA, _mm256_fmadd_ps)   
	ANVIL_SIMD_IMPLEMENTATION_V_VVV_4_TO_8( OP_FMS,   FMA, _mm256_fmsub_ps)  
#undef _simd_element_type
#undef _simd_type
...
#define _simd_type __m128d
	...
	ANVIL_SIMD_IMPLEMENTATION_V_VVV_2( OP_FMA,   FMA,     _mm_fmadd_pd)   
	ANVIL_SIMD_IMPLEMENTATION_V_VVV_2( OP_FMS,   FMA,     _mm_fmsub_pd)  
#undef _simd_element_type
#undef _simd_type
...
#define _simd_type __m256d
	...
	ANVIL_SIMD_IMPLEMENTATION_V_VVV_2_TO_4( OP_FMA,   FMA, _mm256_fmadd_pd)   
	ANVIL_SIMD_IMPLEMENTATION_V_VVV_2_TO_4( OP_FMS,   FMA, _mm256_fmsub_pd)  
#undef _simd_element_type
#undef _simd_type
