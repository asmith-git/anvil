...
#ifndef ANVIL_COMPUTE_SIMD_DIV_HPP
#define ANVIL_COMPUTE_SIMD_DIV_HPP
...
namespace anvil { namespace detail {
	...
	struct VectorDiv<detail::BasicVector<float32_t, 4u>> {
		...
		static ANVIL_STRONG_INLINE type Execute(const type& a, const type& b) throw() {
			...
			if constexpr ((instruction_set & ASM_SSE) != 0ull) {
				...
				a.lower_half = VectorDiv<type::lower_t>::Execute<instruction_set>(a.lower_half, b.lower_half);
				a.upper_half = VectorDiv<type::upper_t>::Execute<instruction_set>(a.upper_half, b.upper_half);
				return a;
			}
		}
	};
	...
	template<>
	struct VectorDiv<detail::BasicVector<float64_t, 4u>> {
		typedef detail::BasicVector<float64_t, 4u> type;

		static ANVIL_STRONG_INLINE type Execute_AVX(type a, const type& b) throw() {
			a.native = _mm256_div_pd(a.native, b.native);
			return a;
		}
	...
	template<>
	struct VectorDiv<detail::BasicVector<float64_t, 8u>> {
		typedef detail::BasicVector<float64_t, 8u> type;

		static ANVIL_STRONG_INLINE type Execute_AVX512F(type a, const type& b) throw() {
			a.native = _mm512_div_pd(a.native, b.native);
			return a;
		}
	...
	struct VectorDiv<detail::BasicVector<T, size>> {
...
namespace anvil {
	...
	static inline T VectorDiv(const T& a, const T& b) throw() {
		return detail::VectorDiv<T>::Execute<instruction_set>(a, b);
	}
}
...
ANVIL_STRONG_INLINE anvil::detail::BasicVector<T, size> operator/(const anvil::detail::BasicVector<T, size>& a, const anvil::detail::BasicVector<T, size>& b) throw() {
	return anvil::VectorDiv<anvil::ASM_MINIMUM, anvil::detail::BasicVector<T, size>>(a, b);
}
...
//// -- f64 --
//
//#ifndef _simd_f64x1_div_safe
//	#define _simd_f64x1_div_safe(X,Y) (X / Y)
//	#define _simd_f64x1_div_(X,Y) x1_div_safe(X,Y)
//	#define _simd_f64x1_div_instruction_set() anvil::simd::IS_NONE
//	#define _simd_f64x1_div_enabled() true
//#endif
//
//#define _simd_f64x2_div_safe(X,Y)_simd_f64x2_combine_safe(\
//	_simd_f64x1_div_safe(_simd_f64x2_splitlo_safe(X), _simd_ f64x2_splitlo_safe(Y)),\
//	_simd_f64x1_div_safe(_simd_f64x2_splithi_safe(X), _simd_ f64x2_splithi_safe(Y)))
...
//#else
//	#define _simd_f64x2_div(X,Y) _simd_f64x2_combine(\
...
//
//
//#if defined(_simd_f64x2_div_) && ! defined(_simd_f64x2_div_scalar_)
//	#define _simd_f64x2_div_scalar_(X,Y) _simd_f64x2_div_(X,_simd_f64x2_fill_scalar_(Y))
//	#define _simd_f64x2_div_scalar_instruction_set _simd_f64x2_div_instruction_set
//#endif
//#ifdef _simd_f64x2_div_scalar_
//	#define _simd_f64x2_div_scalar(X,Y) _simd_f64x2_div_scalar_(X,Y)
//	#define _simd_f64x2_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f64x2_div_scalar_instruction_set>()
//#else
//	#define _simd_f64x2_div_scalar(X,Y) _simd_f64x2_div_safe(X,_simd_f64x2_fill_scalar_safe(Y))
//	#define _simd_f64x2_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_f64x1_div_safe
//	#define _simd_f64x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_f64x4_div_safe(X,Y)_simd_f64x4_combine_safe(\
//	_simd_f64x2_div_safe(_simd_f64x4_splitlo_safe(X), _simd_ f64x4_splitlo_safe(Y)),\
//	_simd_f64x2_div_safe(_simd_f64x4_splithi_safe(X), _simd_ f64x4_splithi_safe(Y)))
...
//#else
//	#define _simd_f64x4_div(X,Y) _simd_f64x4_combine(\
...
//
//
//#if defined(_simd_f64x4_div_) && ! defined(_simd_f64x4_div_scalar_)
//	#define _simd_f64x4_div_scalar_(X,Y) _simd_f64x4_div_(X,_simd_f64x4_fill_scalar_(Y))
//	#define _simd_f64x4_div_scalar_instruction_set _simd_f64x4_div_instruction_set
//#endif
//#ifdef _simd_f64x4_div_scalar_
//	#define _simd_f64x4_div_scalar(X,Y) _simd_f64x4_div_scalar_(X,Y)
//	#define _simd_f64x4_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f64x4_div_scalar_instruction_set>()
//#else
//	#define _simd_f64x4_div_scalar(X,Y) _simd_f64x4_div_safe(X,_simd_f64x4_fill_scalar_safe(Y))
//	#define _simd_f64x4_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_f64x1_div_safe
//	#define _simd_f64x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_f64x8_div_safe(X,Y)_simd_f64x8_combine_safe(\
//	_simd_f64x4_div_safe(_simd_f64x8_splitlo_safe(X), _simd_ f64x8_splitlo_safe(Y)),\
//	_simd_f64x4_div_safe(_simd_f64x8_splithi_safe(X), _simd_ f64x8_splithi_safe(Y)))
...
//#else
//	#define _simd_f64x8_div(X,Y) _simd_f64x8_combine(\
...
//
//
//#if defined(_simd_f64x8_div_) && ! defined(_simd_f64x8_div_scalar_)
//	#define _simd_f64x8_div_scalar_(X,Y) _simd_f64x8_div_(X,_simd_f64x8_fill_scalar_(Y))
//	#define _simd_f64x8_div_scalar_instruction_set _simd_f64x8_div_instruction_set
//#endif
//#ifdef _simd_f64x8_div_scalar_
//	#define _simd_f64x8_div_scalar(X,Y) _simd_f64x8_div_scalar_(X,Y)
//	#define _simd_f64x8_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f64x8_div_scalar_instruction_set>()
//#else
//	#define _simd_f64x8_div_scalar(X,Y) _simd_f64x8_div_safe(X,_simd_f64x8_fill_scalar_safe(Y))
//	#define _simd_f64x8_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_f64x1_div_safe
//	#define _simd_f64x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_f64x16_div_safe(X,Y)_simd_f64x16_combine_safe(\
//	_simd_f64x8_div_safe(_simd_f64x16_splitlo_safe(X), _simd_ f64x16_splitlo_safe(Y)),\
//	_simd_f64x8_div_safe(_simd_f64x16_splithi_safe(X), _simd_ f64x16_splithi_safe(Y)))
...
//#else
//	#define _simd_f64x16_div(X,Y) _simd_f64x16_combine(\
...
//
//
//#if defined(_simd_f64x16_div_) && ! defined(_simd_f64x16_div_scalar_)
//	#define _simd_f64x16_div_scalar_(X,Y) _simd_f64x16_div_(X,_simd_f64x16_fill_scalar_(Y))
//	#define _simd_f64x16_div_scalar_instruction_set _simd_f64x16_div_instruction_set
//#endif
//#ifdef _simd_f64x16_div_scalar_
//	#define _simd_f64x16_div_scalar(X,Y) _simd_f64x16_div_scalar_(X,Y)
//	#define _simd_f64x16_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f64x16_div_scalar_instruction_set>()
//#else
//	#define _simd_f64x16_div_scalar(X,Y) _simd_f64x16_div_safe(X,_simd_f64x16_fill_scalar_safe(Y))
//	#define _simd_f64x16_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_f64x1_div_safe
//	#define _simd_f64x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_f64x32_div_safe(X,Y)_simd_f64x32_combine_safe(\
//	_simd_f64x16_div_safe(_simd_f64x32_splitlo_safe(X), _simd_ f64x32_splitlo_safe(Y)),\
//	_simd_f64x16_div_safe(_simd_f64x32_splithi_safe(X), _simd_ f64x32_splithi_safe(Y)))
...
//#else
//	#define _simd_f64x32_div(X,Y) _simd_f64x32_combine(\
...
//
//
//#if defined(_simd_f64x32_div_) && ! defined(_simd_f64x32_div_scalar_)
//	#define _simd_f64x32_div_scalar_(X,Y) _simd_f64x32_div_(X,_simd_f64x32_fill_scalar_(Y))
//	#define _simd_f64x32_div_scalar_instruction_set _simd_f64x32_div_instruction_set
//#endif
//#ifdef _simd_f64x32_div_scalar_
//	#define _simd_f64x32_div_scalar(X,Y) _simd_f64x32_div_scalar_(X,Y)
//	#define _simd_f64x32_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f64x32_div_scalar_instruction_set>()
//#else
//	#define _simd_f64x32_div_scalar(X,Y) _simd_f64x32_div_safe(X,_simd_f64x32_fill_scalar_safe(Y))
//	#define _simd_f64x32_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_f64x1_div_safe
//	#define _simd_f64x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_f64x64_div_safe(X,Y)_simd_f64x64_combine_safe(\
//	_simd_f64x32_div_safe(_simd_f64x64_splitlo_safe(X), _simd_ f64x64_splitlo_safe(Y)),\
//	_simd_f64x32_div_safe(_simd_f64x64_splithi_safe(X), _simd_ f64x64_splithi_safe(Y)))
...
//#else
//	#define _simd_f64x64_div(X,Y) _simd_f64x64_combine(\
...
//
//
//#if defined(_simd_f64x64_div_) && ! defined(_simd_f64x64_div_scalar_)
//	#define _simd_f64x64_div_scalar_(X,Y) _simd_f64x64_div_(X,_simd_f64x64_fill_scalar_(Y))
//	#define _simd_f64x64_div_scalar_instruction_set _simd_f64x64_div_instruction_set
//#endif
//#ifdef _simd_f64x64_div_scalar_
//	#define _simd_f64x64_div_scalar(X,Y) _simd_f64x64_div_scalar_(X,Y)
//	#define _simd_f64x64_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f64x64_div_scalar_instruction_set>()
//#else
//	#define _simd_f64x64_div_scalar(X,Y) _simd_f64x64_div_safe(X,_simd_f64x64_fill_scalar_safe(Y))
//	#define _simd_f64x64_div_scalar_enabled() true
//#endif
//
//// -- f32 --
//
//#ifndef _simd_f32x1_div_safe
//	#define _simd_f32x1_div_safe(X,Y) (X / Y)
//	#define _simd_f32x1_div_(X,Y) x1_div_safe(X,Y)
//	#define _simd_f32x1_div_instruction_set() anvil::simd::IS_NONE
//	#define _simd_f32x1_div_enabled() true
//#endif
//
//#define _simd_f32x2_div_safe(X,Y)_simd_f32x2_combine_safe(\
//	_simd_f32x1_div_safe(_simd_f32x2_splitlo_safe(X), _simd_ f32x2_splitlo_safe(Y)),\
//	_simd_f32x1_div_safe(_simd_f32x2_splithi_safe(X), _simd_ f32x2_splithi_safe(Y)))
...
//#else
//	#define _simd_f32x2_div(X,Y) _simd_f32x2_combine(\
...
//
//
//#if defined(_simd_f32x2_div_) && ! defined(_simd_f32x2_div_scalar_)
//	#define _simd_f32x2_div_scalar_(X,Y) _simd_f32x2_div_(X,_simd_f32x2_fill_scalar_(Y))
//	#define _simd_f32x2_div_scalar_instruction_set _simd_f32x2_div_instruction_set
//#endif
//#ifdef _simd_f32x2_div_scalar_
//	#define _simd_f32x2_div_scalar(X,Y) _simd_f32x2_div_scalar_(X,Y)
//	#define _simd_f32x2_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f32x2_div_scalar_instruction_set>()
//#else
//	#define _simd_f32x2_div_scalar(X,Y) _simd_f32x2_div_safe(X,_simd_f32x2_fill_scalar_safe(Y))
//	#define _simd_f32x2_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_f32x1_div_safe
//	#define _simd_f32x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_f32x4_div_safe(X,Y)_simd_f32x4_combine_safe(\
//	_simd_f32x2_div_safe(_simd_f32x4_splitlo_safe(X), _simd_ f32x4_splitlo_safe(Y)),\
//	_simd_f32x2_div_safe(_simd_f32x4_splithi_safe(X), _simd_ f32x4_splithi_safe(Y)))
...
//#else
//	#define _simd_f32x4_div(X,Y) _simd_f32x4_combine(\
...
//
//
//#if defined(_simd_f32x4_div_) && ! defined(_simd_f32x4_div_scalar_)
//	#define _simd_f32x4_div_scalar_(X,Y) _simd_f32x4_div_(X,_simd_f32x4_fill_scalar_(Y))
//	#define _simd_f32x4_div_scalar_instruction_set _simd_f32x4_div_instruction_set
//#endif
//#ifdef _simd_f32x4_div_scalar_
//	#define _simd_f32x4_div_scalar(X,Y) _simd_f32x4_div_scalar_(X,Y)
//	#define _simd_f32x4_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f32x4_div_scalar_instruction_set>()
//#else
//	#define _simd_f32x4_div_scalar(X,Y) _simd_f32x4_div_safe(X,_simd_f32x4_fill_scalar_safe(Y))
//	#define _simd_f32x4_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_f32x1_div_safe
//	#define _simd_f32x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_f32x8_div_safe(X,Y)_simd_f32x8_combine_safe(\
//	_simd_f32x4_div_safe(_simd_f32x8_splitlo_safe(X), _simd_ f32x8_splitlo_safe(Y)),\
//	_simd_f32x4_div_safe(_simd_f32x8_splithi_safe(X), _simd_ f32x8_splithi_safe(Y)))
...
//#else
//	#define _simd_f32x8_div(X,Y) _simd_f32x8_combine(\
...
//
//
//#if defined(_simd_f32x8_div_) && ! defined(_simd_f32x8_div_scalar_)
//	#define _simd_f32x8_div_scalar_(X,Y) _simd_f32x8_div_(X,_simd_f32x8_fill_scalar_(Y))
//	#define _simd_f32x8_div_scalar_instruction_set _simd_f32x8_div_instruction_set
//#endif
//#ifdef _simd_f32x8_div_scalar_
//	#define _simd_f32x8_div_scalar(X,Y) _simd_f32x8_div_scalar_(X,Y)
//	#define _simd_f32x8_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f32x8_div_scalar_instruction_set>()
//#else
//	#define _simd_f32x8_div_scalar(X,Y) _simd_f32x8_div_safe(X,_simd_f32x8_fill_scalar_safe(Y))
//	#define _simd_f32x8_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_f32x1_div_safe
//	#define _simd_f32x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_f32x16_div_safe(X,Y)_simd_f32x16_combine_safe(\
//	_simd_f32x8_div_safe(_simd_f32x16_splitlo_safe(X), _simd_ f32x16_splitlo_safe(Y)),\
//	_simd_f32x8_div_safe(_simd_f32x16_splithi_safe(X), _simd_ f32x16_splithi_safe(Y)))
...
//#else
//	#define _simd_f32x16_div(X,Y) _simd_f32x16_combine(\
...
//
//
//#if defined(_simd_f32x16_div_) && ! defined(_simd_f32x16_div_scalar_)
//	#define _simd_f32x16_div_scalar_(X,Y) _simd_f32x16_div_(X,_simd_f32x16_fill_scalar_(Y))
//	#define _simd_f32x16_div_scalar_instruction_set _simd_f32x16_div_instruction_set
//#endif
//#ifdef _simd_f32x16_div_scalar_
//	#define _simd_f32x16_div_scalar(X,Y) _simd_f32x16_div_scalar_(X,Y)
//	#define _simd_f32x16_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f32x16_div_scalar_instruction_set>()
//#else
//	#define _simd_f32x16_div_scalar(X,Y) _simd_f32x16_div_safe(X,_simd_f32x16_fill_scalar_safe(Y))
//	#define _simd_f32x16_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_f32x1_div_safe
//	#define _simd_f32x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_f32x32_div_safe(X,Y)_simd_f32x32_combine_safe(\
//	_simd_f32x16_div_safe(_simd_f32x32_splitlo_safe(X), _simd_ f32x32_splitlo_safe(Y)),\
//	_simd_f32x16_div_safe(_simd_f32x32_splithi_safe(X), _simd_ f32x32_splithi_safe(Y)))
...
//#else
//	#define _simd_f32x32_div(X,Y) _simd_f32x32_combine(\
...
//
//
//#if defined(_simd_f32x32_div_) && ! defined(_simd_f32x32_div_scalar_)
//	#define _simd_f32x32_div_scalar_(X,Y) _simd_f32x32_div_(X,_simd_f32x32_fill_scalar_(Y))
//	#define _simd_f32x32_div_scalar_instruction_set _simd_f32x32_div_instruction_set
//#endif
//#ifdef _simd_f32x32_div_scalar_
//	#define _simd_f32x32_div_scalar(X,Y) _simd_f32x32_div_scalar_(X,Y)
//	#define _simd_f32x32_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f32x32_div_scalar_instruction_set>()
//#else
//	#define _simd_f32x32_div_scalar(X,Y) _simd_f32x32_div_safe(X,_simd_f32x32_fill_scalar_safe(Y))
//	#define _simd_f32x32_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_f32x1_div_safe
//	#define _simd_f32x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_f32x64_div_safe(X,Y)_simd_f32x64_combine_safe(\
//	_simd_f32x32_div_safe(_simd_f32x64_splitlo_safe(X), _simd_ f32x64_splitlo_safe(Y)),\
//	_simd_f32x32_div_safe(_simd_f32x64_splithi_safe(X), _simd_ f32x64_splithi_safe(Y)))
...
//#else
//	#define _simd_f32x64_div(X,Y) _simd_f32x64_combine(\
...
//
//
//#if defined(_simd_f32x64_div_) && ! defined(_simd_f32x64_div_scalar_)
//	#define _simd_f32x64_div_scalar_(X,Y) _simd_f32x64_div_(X,_simd_f32x64_fill_scalar_(Y))
//	#define _simd_f32x64_div_scalar_instruction_set _simd_f32x64_div_instruction_set
//#endif
//#ifdef _simd_f32x64_div_scalar_
//	#define _simd_f32x64_div_scalar(X,Y) _simd_f32x64_div_scalar_(X,Y)
//	#define _simd_f32x64_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f32x64_div_scalar_instruction_set>()
//#else
//	#define _simd_f32x64_div_scalar(X,Y) _simd_f32x64_div_safe(X,_simd_f32x64_fill_scalar_safe(Y))
//	#define _simd_f32x64_div_scalar_enabled() true
//#endif
//
//// -- s64 --
//
//#ifndef _simd_s64x1_div_safe
//	#define _simd_s64x1_div_safe(X,Y) (X / Y)
//	#define _simd_s64x1_div_(X,Y) x1_div_safe(X,Y)
//	#define _simd_s64x1_div_instruction_set() anvil::simd::IS_NONE
//	#define _simd_s64x1_div_enabled() true
//#endif
//
//#define _simd_s64x2_div_safe(X,Y)_simd_s64x2_combine_safe(\
//	_simd_s64x1_div_safe(_simd_s64x2_splitlo_safe(X), _simd_ s64x2_splitlo_safe(Y)),\
//	_simd_s64x1_div_safe(_simd_s64x2_splithi_safe(X), _simd_ s64x2_splithi_safe(Y)))
...
//#else
//	#define _simd_s64x2_div(X,Y) _simd_s64x2_combine(\
...
//
//
//#if defined(_simd_s64x2_div_) && ! defined(_simd_s64x2_div_scalar_)
//	#define _simd_s64x2_div_scalar_(X,Y) _simd_s64x2_div_(X,_simd_s64x2_fill_scalar_(Y))
//	#define _simd_s64x2_div_scalar_instruction_set _simd_s64x2_div_instruction_set
//#endif
//#ifdef _simd_s64x2_div_scalar_
//	#define _simd_s64x2_div_scalar(X,Y) _simd_s64x2_div_scalar_(X,Y)
//	#define _simd_s64x2_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s64x2_div_scalar_instruction_set>()
//#else
//	#define _simd_s64x2_div_scalar(X,Y) _simd_s64x2_div_safe(X,_simd_s64x2_fill_scalar_safe(Y))
//	#define _simd_s64x2_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_s64x1_div_safe
//	#define _simd_s64x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_s64x4_div_safe(X,Y)_simd_s64x4_combine_safe(\
//	_simd_s64x2_div_safe(_simd_s64x4_splitlo_safe(X), _simd_ s64x4_splitlo_safe(Y)),\
//	_simd_s64x2_div_safe(_simd_s64x4_splithi_safe(X), _simd_ s64x4_splithi_safe(Y)))
...
//#else
//	#define _simd_s64x4_div(X,Y) _simd_s64x4_combine(\
...
//
//
//#if defined(_simd_s64x4_div_) && ! defined(_simd_s64x4_div_scalar_)
//	#define _simd_s64x4_div_scalar_(X,Y) _simd_s64x4_div_(X,_simd_s64x4_fill_scalar_(Y))
//	#define _simd_s64x4_div_scalar_instruction_set _simd_s64x4_div_instruction_set
//#endif
//#ifdef _simd_s64x4_div_scalar_
//	#define _simd_s64x4_div_scalar(X,Y) _simd_s64x4_div_scalar_(X,Y)
//	#define _simd_s64x4_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s64x4_div_scalar_instruction_set>()
//#else
//	#define _simd_s64x4_div_scalar(X,Y) _simd_s64x4_div_safe(X,_simd_s64x4_fill_scalar_safe(Y))
//	#define _simd_s64x4_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_s64x1_div_safe
//	#define _simd_s64x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_s64x8_div_safe(X,Y)_simd_s64x8_combine_safe(\
//	_simd_s64x4_div_safe(_simd_s64x8_splitlo_safe(X), _simd_ s64x8_splitlo_safe(Y)),\
//	_simd_s64x4_div_safe(_simd_s64x8_splithi_safe(X), _simd_ s64x8_splithi_safe(Y)))
...
//#else
//	#define _simd_s64x8_div(X,Y) _simd_s64x8_combine(\
...
//
//
//#if defined(_simd_s64x8_div_) && ! defined(_simd_s64x8_div_scalar_)
//	#define _simd_s64x8_div_scalar_(X,Y) _simd_s64x8_div_(X,_simd_s64x8_fill_scalar_(Y))
//	#define _simd_s64x8_div_scalar_instruction_set _simd_s64x8_div_instruction_set
//#endif
//#ifdef _simd_s64x8_div_scalar_
//	#define _simd_s64x8_div_scalar(X,Y) _simd_s64x8_div_scalar_(X,Y)
//	#define _simd_s64x8_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s64x8_div_scalar_instruction_set>()
//#else
//	#define _simd_s64x8_div_scalar(X,Y) _simd_s64x8_div_safe(X,_simd_s64x8_fill_scalar_safe(Y))
//	#define _simd_s64x8_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_s64x1_div_safe
//	#define _simd_s64x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_s64x16_div_safe(X,Y)_simd_s64x16_combine_safe(\
//	_simd_s64x8_div_safe(_simd_s64x16_splitlo_safe(X), _simd_ s64x16_splitlo_safe(Y)),\
//	_simd_s64x8_div_safe(_simd_s64x16_splithi_safe(X), _simd_ s64x16_splithi_safe(Y)))
...
//#else
//	#define _simd_s64x16_div(X,Y) _simd_s64x16_combine(\
...
//
//
//#if defined(_simd_s64x16_div_) && ! defined(_simd_s64x16_div_scalar_)
//	#define _simd_s64x16_div_scalar_(X,Y) _simd_s64x16_div_(X,_simd_s64x16_fill_scalar_(Y))
//	#define _simd_s64x16_div_scalar_instruction_set _simd_s64x16_div_instruction_set
//#endif
//#ifdef _simd_s64x16_div_scalar_
//	#define _simd_s64x16_div_scalar(X,Y) _simd_s64x16_div_scalar_(X,Y)
//	#define _simd_s64x16_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s64x16_div_scalar_instruction_set>()
//#else
//	#define _simd_s64x16_div_scalar(X,Y) _simd_s64x16_div_safe(X,_simd_s64x16_fill_scalar_safe(Y))
//	#define _simd_s64x16_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_s64x1_div_safe
//	#define _simd_s64x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_s64x32_div_safe(X,Y)_simd_s64x32_combine_safe(\
//	_simd_s64x16_div_safe(_simd_s64x32_splitlo_safe(X), _simd_ s64x32_splitlo_safe(Y)),\
//	_simd_s64x16_div_safe(_simd_s64x32_splithi_safe(X), _simd_ s64x32_splithi_safe(Y)))
...
//#else
//	#define _simd_s64x32_div(X,Y) _simd_s64x32_combine(\
...
//
//
//#if defined(_simd_s64x32_div_) && ! defined(_simd_s64x32_div_scalar_)
//	#define _simd_s64x32_div_scalar_(X,Y) _simd_s64x32_div_(X,_simd_s64x32_fill_scalar_(Y))
//	#define _simd_s64x32_div_scalar_instruction_set _simd_s64x32_div_instruction_set
//#endif
//#ifdef _simd_s64x32_div_scalar_
//	#define _simd_s64x32_div_scalar(X,Y) _simd_s64x32_div_scalar_(X,Y)
//	#define _simd_s64x32_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s64x32_div_scalar_instruction_set>()
//#else
//	#define _simd_s64x32_div_scalar(X,Y) _simd_s64x32_div_safe(X,_simd_s64x32_fill_scalar_safe(Y))
//	#define _simd_s64x32_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_s64x1_div_safe
//	#define _simd_s64x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_s64x64_div_safe(X,Y)_simd_s64x64_combine_safe(\
//	_simd_s64x32_div_safe(_simd_s64x64_splitlo_safe(X), _simd_ s64x64_splitlo_safe(Y)),\
//	_simd_s64x32_div_safe(_simd_s64x64_splithi_safe(X), _simd_ s64x64_splithi_safe(Y)))
...
//#else
//	#define _simd_s64x64_div(X,Y) _simd_s64x64_combine(\
...
//
//
//#if defined(_simd_s64x64_div_) && ! defined(_simd_s64x64_div_scalar_)
//	#define _simd_s64x64_div_scalar_(X,Y) _simd_s64x64_div_(X,_simd_s64x64_fill_scalar_(Y))
//	#define _simd_s64x64_div_scalar_instruction_set _simd_s64x64_div_instruction_set
//#endif
//#ifdef _simd_s64x64_div_scalar_
//	#define _simd_s64x64_div_scalar(X,Y) _simd_s64x64_div_scalar_(X,Y)
//	#define _simd_s64x64_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s64x64_div_scalar_instruction_set>()
//#else
//	#define _simd_s64x64_div_scalar(X,Y) _simd_s64x64_div_safe(X,_simd_s64x64_fill_scalar_safe(Y))
//	#define _simd_s64x64_div_scalar_enabled() true
//#endif
//
//// -- u64 --
//
//#ifndef _simd_u64x1_div_safe
//	#define _simd_u64x1_div_safe(X,Y) (X / Y)
//	#define _simd_u64x1_div_(X,Y) x1_div_safe(X,Y)
//	#define _simd_u64x1_div_instruction_set() anvil::simd::IS_NONE
//	#define _simd_u64x1_div_enabled() true
//#endif
//
//#define _simd_u64x2_div_safe(X,Y)_simd_u64x2_combine_safe(\
//	_simd_u64x1_div_safe(_simd_u64x2_splitlo_safe(X), _simd_ u64x2_splitlo_safe(Y)),\
//	_simd_u64x1_div_safe(_simd_u64x2_splithi_safe(X), _simd_ u64x2_splithi_safe(Y)))
...
//#else
//	#define _simd_u64x2_div(X,Y) _simd_u64x2_combine(\
...
//
//
//#if defined(_simd_u64x2_div_) && ! defined(_simd_u64x2_div_scalar_)
//	#define _simd_u64x2_div_scalar_(X,Y) _simd_u64x2_div_(X,_simd_u64x2_fill_scalar_(Y))
//	#define _simd_u64x2_div_scalar_instruction_set _simd_u64x2_div_instruction_set
//#endif
//#ifdef _simd_u64x2_div_scalar_
//	#define _simd_u64x2_div_scalar(X,Y) _simd_u64x2_div_scalar_(X,Y)
//	#define _simd_u64x2_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u64x2_div_scalar_instruction_set>()
//#else
//	#define _simd_u64x2_div_scalar(X,Y) _simd_u64x2_div_safe(X,_simd_u64x2_fill_scalar_safe(Y))
//	#define _simd_u64x2_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_u64x1_div_safe
//	#define _simd_u64x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_u64x4_div_safe(X,Y)_simd_u64x4_combine_safe(\
//	_simd_u64x2_div_safe(_simd_u64x4_splitlo_safe(X), _simd_ u64x4_splitlo_safe(Y)),\
//	_simd_u64x2_div_safe(_simd_u64x4_splithi_safe(X), _simd_ u64x4_splithi_safe(Y)))
...
//#else
//	#define _simd_u64x4_div(X,Y) _simd_u64x4_combine(\
...
//
//
//#if defined(_simd_u64x4_div_) && ! defined(_simd_u64x4_div_scalar_)
//	#define _simd_u64x4_div_scalar_(X,Y) _simd_u64x4_div_(X,_simd_u64x4_fill_scalar_(Y))
//	#define _simd_u64x4_div_scalar_instruction_set _simd_u64x4_div_instruction_set
//#endif
//#ifdef _simd_u64x4_div_scalar_
//	#define _simd_u64x4_div_scalar(X,Y) _simd_u64x4_div_scalar_(X,Y)
//	#define _simd_u64x4_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u64x4_div_scalar_instruction_set>()
//#else
//	#define _simd_u64x4_div_scalar(X,Y) _simd_u64x4_div_safe(X,_simd_u64x4_fill_scalar_safe(Y))
//	#define _simd_u64x4_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_u64x1_div_safe
//	#define _simd_u64x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_u64x8_div_safe(X,Y)_simd_u64x8_combine_safe(\
//	_simd_u64x4_div_safe(_simd_u64x8_splitlo_safe(X), _simd_ u64x8_splitlo_safe(Y)),\
//	_simd_u64x4_div_safe(_simd_u64x8_splithi_safe(X), _simd_ u64x8_splithi_safe(Y)))
...
//#else
//	#define _simd_u64x8_div(X,Y) _simd_u64x8_combine(\
...
//
//
//#if defined(_simd_u64x8_div_) && ! defined(_simd_u64x8_div_scalar_)
//	#define _simd_u64x8_div_scalar_(X,Y) _simd_u64x8_div_(X,_simd_u64x8_fill_scalar_(Y))
//	#define _simd_u64x8_div_scalar_instruction_set _simd_u64x8_div_instruction_set
//#endif
//#ifdef _simd_u64x8_div_scalar_
//	#define _simd_u64x8_div_scalar(X,Y) _simd_u64x8_div_scalar_(X,Y)
//	#define _simd_u64x8_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u64x8_div_scalar_instruction_set>()
//#else
//	#define _simd_u64x8_div_scalar(X,Y) _simd_u64x8_div_safe(X,_simd_u64x8_fill_scalar_safe(Y))
//	#define _simd_u64x8_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_u64x1_div_safe
//	#define _simd_u64x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_u64x16_div_safe(X,Y)_simd_u64x16_combine_safe(\
//	_simd_u64x8_div_safe(_simd_u64x16_splitlo_safe(X), _simd_ u64x16_splitlo_safe(Y)),\
//	_simd_u64x8_div_safe(_simd_u64x16_splithi_safe(X), _simd_ u64x16_splithi_safe(Y)))
...
//#else
//	#define _simd_u64x16_div(X,Y) _simd_u64x16_combine(\
...
//
//
//#if defined(_simd_u64x16_div_) && ! defined(_simd_u64x16_div_scalar_)
//	#define _simd_u64x16_div_scalar_(X,Y) _simd_u64x16_div_(X,_simd_u64x16_fill_scalar_(Y))
//	#define _simd_u64x16_div_scalar_instruction_set _simd_u64x16_div_instruction_set
//#endif
//#ifdef _simd_u64x16_div_scalar_
//	#define _simd_u64x16_div_scalar(X,Y) _simd_u64x16_div_scalar_(X,Y)
//	#define _simd_u64x16_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u64x16_div_scalar_instruction_set>()
//#else
//	#define _simd_u64x16_div_scalar(X,Y) _simd_u64x16_div_safe(X,_simd_u64x16_fill_scalar_safe(Y))
//	#define _simd_u64x16_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_u64x1_div_safe
//	#define _simd_u64x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_u64x32_div_safe(X,Y)_simd_u64x32_combine_safe(\
//	_simd_u64x16_div_safe(_simd_u64x32_splitlo_safe(X), _simd_ u64x32_splitlo_safe(Y)),\
//	_simd_u64x16_div_safe(_simd_u64x32_splithi_safe(X), _simd_ u64x32_splithi_safe(Y)))
...
//#else
//	#define _simd_u64x32_div(X,Y) _simd_u64x32_combine(\
...
//
//
//#if defined(_simd_u64x32_div_) && ! defined(_simd_u64x32_div_scalar_)
//	#define _simd_u64x32_div_scalar_(X,Y) _simd_u64x32_div_(X,_simd_u64x32_fill_scalar_(Y))
//	#define _simd_u64x32_div_scalar_instruction_set _simd_u64x32_div_instruction_set
//#endif
//#ifdef _simd_u64x32_div_scalar_
//	#define _simd_u64x32_div_scalar(X,Y) _simd_u64x32_div_scalar_(X,Y)
//	#define _simd_u64x32_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u64x32_div_scalar_instruction_set>()
//#else
//	#define _simd_u64x32_div_scalar(X,Y) _simd_u64x32_div_safe(X,_simd_u64x32_fill_scalar_safe(Y))
//	#define _simd_u64x32_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_u64x1_div_safe
//	#define _simd_u64x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_u64x64_div_safe(X,Y)_simd_u64x64_combine_safe(\
//	_simd_u64x32_div_safe(_simd_u64x64_splitlo_safe(X), _simd_ u64x64_splitlo_safe(Y)),\
//	_simd_u64x32_div_safe(_simd_u64x64_splithi_safe(X), _simd_ u64x64_splithi_safe(Y)))
...
//#else
//	#define _simd_u64x64_div(X,Y) _simd_u64x64_combine(\
...
//
//
//#if defined(_simd_u64x64_div_) && ! defined(_simd_u64x64_div_scalar_)
//	#define _simd_u64x64_div_scalar_(X,Y) _simd_u64x64_div_(X,_simd_u64x64_fill_scalar_(Y))
//	#define _simd_u64x64_div_scalar_instruction_set _simd_u64x64_div_instruction_set
//#endif
//#ifdef _simd_u64x64_div_scalar_
//	#define _simd_u64x64_div_scalar(X,Y) _simd_u64x64_div_scalar_(X,Y)
//	#define _simd_u64x64_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u64x64_div_scalar_instruction_set>()
//#else
//	#define _simd_u64x64_div_scalar(X,Y) _simd_u64x64_div_safe(X,_simd_u64x64_fill_scalar_safe(Y))
//	#define _simd_u64x64_div_scalar_enabled() true
//#endif
//
//// -- s32 --
//
//#ifndef _simd_s32x1_div_safe
//	#define _simd_s32x1_div_safe(X,Y) (X / Y)
//	#define _simd_s32x1_div_(X,Y) x1_div_safe(X,Y)
//	#define _simd_s32x1_div_instruction_set() anvil::simd::IS_NONE
//	#define _simd_s32x1_div_enabled() true
//#endif
//
//#define _simd_s32x2_div_safe(X,Y)_simd_s32x2_combine_safe(\
//	_simd_s32x1_div_safe(_simd_s32x2_splitlo_safe(X), _simd_ s32x2_splitlo_safe(Y)),\
//	_simd_s32x1_div_safe(_simd_s32x2_splithi_safe(X), _simd_ s32x2_splithi_safe(Y)))
...
//#else
//	#define _simd_s32x2_div(X,Y) _simd_s32x2_combine(\
...
//
//
//#if defined(_simd_s32x2_div_) && ! defined(_simd_s32x2_div_scalar_)
//	#define _simd_s32x2_div_scalar_(X,Y) _simd_s32x2_div_(X,_simd_s32x2_fill_scalar_(Y))
//	#define _simd_s32x2_div_scalar_instruction_set _simd_s32x2_div_instruction_set
//#endif
//#ifdef _simd_s32x2_div_scalar_
//	#define _simd_s32x2_div_scalar(X,Y) _simd_s32x2_div_scalar_(X,Y)
//	#define _simd_s32x2_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s32x2_div_scalar_instruction_set>()
//#else
//	#define _simd_s32x2_div_scalar(X,Y) _simd_s32x2_div_safe(X,_simd_s32x2_fill_scalar_safe(Y))
//	#define _simd_s32x2_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_s32x1_div_safe
//	#define _simd_s32x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_s32x4_div_safe(X,Y)_simd_s32x4_combine_safe(\
//	_simd_s32x2_div_safe(_simd_s32x4_splitlo_safe(X), _simd_ s32x4_splitlo_safe(Y)),\
//	_simd_s32x2_div_safe(_simd_s32x4_splithi_safe(X), _simd_ s32x4_splithi_safe(Y)))
...
//#else
//	#define _simd_s32x4_div(X,Y) _simd_s32x4_combine(\
...
//
//
//#if defined(_simd_s32x4_div_) && ! defined(_simd_s32x4_div_scalar_)
//	#define _simd_s32x4_div_scalar_(X,Y) _simd_s32x4_div_(X,_simd_s32x4_fill_scalar_(Y))
//	#define _simd_s32x4_div_scalar_instruction_set _simd_s32x4_div_instruction_set
//#endif
//#ifdef _simd_s32x4_div_scalar_
//	#define _simd_s32x4_div_scalar(X,Y) _simd_s32x4_div_scalar_(X,Y)
//	#define _simd_s32x4_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s32x4_div_scalar_instruction_set>()
//#else
//	#define _simd_s32x4_div_scalar(X,Y) _simd_s32x4_div_safe(X,_simd_s32x4_fill_scalar_safe(Y))
//	#define _simd_s32x4_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_s32x1_div_safe
//	#define _simd_s32x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_s32x8_div_safe(X,Y)_simd_s32x8_combine_safe(\
//	_simd_s32x4_div_safe(_simd_s32x8_splitlo_safe(X), _simd_ s32x8_splitlo_safe(Y)),\
//	_simd_s32x4_div_safe(_simd_s32x8_splithi_safe(X), _simd_ s32x8_splithi_safe(Y)))
...
//#else
//	#define _simd_s32x8_div(X,Y) _simd_s32x8_combine(\
...
//
//
//#if defined(_simd_s32x8_div_) && ! defined(_simd_s32x8_div_scalar_)
//	#define _simd_s32x8_div_scalar_(X,Y) _simd_s32x8_div_(X,_simd_s32x8_fill_scalar_(Y))
//	#define _simd_s32x8_div_scalar_instruction_set _simd_s32x8_div_instruction_set
//#endif
//#ifdef _simd_s32x8_div_scalar_
//	#define _simd_s32x8_div_scalar(X,Y) _simd_s32x8_div_scalar_(X,Y)
//	#define _simd_s32x8_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s32x8_div_scalar_instruction_set>()
//#else
//	#define _simd_s32x8_div_scalar(X,Y) _simd_s32x8_div_safe(X,_simd_s32x8_fill_scalar_safe(Y))
//	#define _simd_s32x8_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_s32x1_div_safe
//	#define _simd_s32x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_s32x16_div_safe(X,Y)_simd_s32x16_combine_safe(\
//	_simd_s32x8_div_safe(_simd_s32x16_splitlo_safe(X), _simd_ s32x16_splitlo_safe(Y)),\
//	_simd_s32x8_div_safe(_simd_s32x16_splithi_safe(X), _simd_ s32x16_splithi_safe(Y)))
...
//#else
//	#define _simd_s32x16_div(X,Y) _simd_s32x16_combine(\
...
//
//
//#if defined(_simd_s32x16_div_) && ! defined(_simd_s32x16_div_scalar_)
//	#define _simd_s32x16_div_scalar_(X,Y) _simd_s32x16_div_(X,_simd_s32x16_fill_scalar_(Y))
//	#define _simd_s32x16_div_scalar_instruction_set _simd_s32x16_div_instruction_set
//#endif
//#ifdef _simd_s32x16_div_scalar_
//	#define _simd_s32x16_div_scalar(X,Y) _simd_s32x16_div_scalar_(X,Y)
//	#define _simd_s32x16_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s32x16_div_scalar_instruction_set>()
//#else
//	#define _simd_s32x16_div_scalar(X,Y) _simd_s32x16_div_safe(X,_simd_s32x16_fill_scalar_safe(Y))
//	#define _simd_s32x16_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_s32x1_div_safe
//	#define _simd_s32x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_s32x32_div_safe(X,Y)_simd_s32x32_combine_safe(\
//	_simd_s32x16_div_safe(_simd_s32x32_splitlo_safe(X), _simd_ s32x32_splitlo_safe(Y)),\
//	_simd_s32x16_div_safe(_simd_s32x32_splithi_safe(X), _simd_ s32x32_splithi_safe(Y)))
...
//#else
//	#define _simd_s32x32_div(X,Y) _simd_s32x32_combine(\
...
//
//
//#if defined(_simd_s32x32_div_) && ! defined(_simd_s32x32_div_scalar_)
//	#define _simd_s32x32_div_scalar_(X,Y) _simd_s32x32_div_(X,_simd_s32x32_fill_scalar_(Y))
//	#define _simd_s32x32_div_scalar_instruction_set _simd_s32x32_div_instruction_set
//#endif
//#ifdef _simd_s32x32_div_scalar_
//	#define _simd_s32x32_div_scalar(X,Y) _simd_s32x32_div_scalar_(X,Y)
//	#define _simd_s32x32_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s32x32_div_scalar_instruction_set>()
//#else
//	#define _simd_s32x32_div_scalar(X,Y) _simd_s32x32_div_safe(X,_simd_s32x32_fill_scalar_safe(Y))
//	#define _simd_s32x32_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_s32x1_div_safe
//	#define _simd_s32x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_s32x64_div_safe(X,Y)_simd_s32x64_combine_safe(\
//	_simd_s32x32_div_safe(_simd_s32x64_splitlo_safe(X), _simd_ s32x64_splitlo_safe(Y)),\
//	_simd_s32x32_div_safe(_simd_s32x64_splithi_safe(X), _simd_ s32x64_splithi_safe(Y)))
...
//#else
//	#define _simd_s32x64_div(X,Y) _simd_s32x64_combine(\
...
//
//
//#if defined(_simd_s32x64_div_) && ! defined(_simd_s32x64_div_scalar_)
//	#define _simd_s32x64_div_scalar_(X,Y) _simd_s32x64_div_(X,_simd_s32x64_fill_scalar_(Y))
//	#define _simd_s32x64_div_scalar_instruction_set _simd_s32x64_div_instruction_set
//#endif
//#ifdef _simd_s32x64_div_scalar_
//	#define _simd_s32x64_div_scalar(X,Y) _simd_s32x64_div_scalar_(X,Y)
//	#define _simd_s32x64_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s32x64_div_scalar_instruction_set>()
//#else
//	#define _simd_s32x64_div_scalar(X,Y) _simd_s32x64_div_safe(X,_simd_s32x64_fill_scalar_safe(Y))
//	#define _simd_s32x64_div_scalar_enabled() true
//#endif
//
//// -- u32 --
//
//#ifndef _simd_u32x1_div_safe
//	#define _simd_u32x1_div_safe(X,Y) (X / Y)
//	#define _simd_u32x1_div_(X,Y) x1_div_safe(X,Y)
//	#define _simd_u32x1_div_instruction_set() anvil::simd::IS_NONE
//	#define _simd_u32x1_div_enabled() true
//#endif
//
//#define _simd_u32x2_div_safe(X,Y)_simd_u32x2_combine_safe(\
//	_simd_u32x1_div_safe(_simd_u32x2_splitlo_safe(X), _simd_ u32x2_splitlo_safe(Y)),\
//	_simd_u32x1_div_safe(_simd_u32x2_splithi_safe(X), _simd_ u32x2_splithi_safe(Y)))
...
//#else
//	#define _simd_u32x2_div(X,Y) _simd_u32x2_combine(\
...
//
//
//#if defined(_simd_u32x2_div_) && ! defined(_simd_u32x2_div_scalar_)
//	#define _simd_u32x2_div_scalar_(X,Y) _simd_u32x2_div_(X,_simd_u32x2_fill_scalar_(Y))
//	#define _simd_u32x2_div_scalar_instruction_set _simd_u32x2_div_instruction_set
//#endif
//#ifdef _simd_u32x2_div_scalar_
//	#define _simd_u32x2_div_scalar(X,Y) _simd_u32x2_div_scalar_(X,Y)
//	#define _simd_u32x2_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u32x2_div_scalar_instruction_set>()
//#else
//	#define _simd_u32x2_div_scalar(X,Y) _simd_u32x2_div_safe(X,_simd_u32x2_fill_scalar_safe(Y))
//	#define _simd_u32x2_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_u32x1_div_safe
//	#define _simd_u32x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_u32x4_div_safe(X,Y)_simd_u32x4_combine_safe(\
//	_simd_u32x2_div_safe(_simd_u32x4_splitlo_safe(X), _simd_ u32x4_splitlo_safe(Y)),\
//	_simd_u32x2_div_safe(_simd_u32x4_splithi_safe(X), _simd_ u32x4_splithi_safe(Y)))
...
//#else
//	#define _simd_u32x4_div(X,Y) _simd_u32x4_combine(\
...
//
//
//#if defined(_simd_u32x4_div_) && ! defined(_simd_u32x4_div_scalar_)
//	#define _simd_u32x4_div_scalar_(X,Y) _simd_u32x4_div_(X,_simd_u32x4_fill_scalar_(Y))
//	#define _simd_u32x4_div_scalar_instruction_set _simd_u32x4_div_instruction_set
//#endif
//#ifdef _simd_u32x4_div_scalar_
//	#define _simd_u32x4_div_scalar(X,Y) _simd_u32x4_div_scalar_(X,Y)
//	#define _simd_u32x4_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u32x4_div_scalar_instruction_set>()
//#else
//	#define _simd_u32x4_div_scalar(X,Y) _simd_u32x4_div_safe(X,_simd_u32x4_fill_scalar_safe(Y))
//	#define _simd_u32x4_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_u32x1_div_safe
//	#define _simd_u32x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_u32x8_div_safe(X,Y)_simd_u32x8_combine_safe(\
//	_simd_u32x4_div_safe(_simd_u32x8_splitlo_safe(X), _simd_ u32x8_splitlo_safe(Y)),\
//	_simd_u32x4_div_safe(_simd_u32x8_splithi_safe(X), _simd_ u32x8_splithi_safe(Y)))
...
//#else
//	#define _simd_u32x8_div(X,Y) _simd_u32x8_combine(\
...
//
//
//#if defined(_simd_u32x8_div_) && ! defined(_simd_u32x8_div_scalar_)
//	#define _simd_u32x8_div_scalar_(X,Y) _simd_u32x8_div_(X,_simd_u32x8_fill_scalar_(Y))
//	#define _simd_u32x8_div_scalar_instruction_set _simd_u32x8_div_instruction_set
//#endif
//#ifdef _simd_u32x8_div_scalar_
//	#define _simd_u32x8_div_scalar(X,Y) _simd_u32x8_div_scalar_(X,Y)
//	#define _simd_u32x8_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u32x8_div_scalar_instruction_set>()
//#else
//	#define _simd_u32x8_div_scalar(X,Y) _simd_u32x8_div_safe(X,_simd_u32x8_fill_scalar_safe(Y))
//	#define _simd_u32x8_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_u32x1_div_safe
//	#define _simd_u32x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_u32x16_div_safe(X,Y)_simd_u32x16_combine_safe(\
//	_simd_u32x8_div_safe(_simd_u32x16_splitlo_safe(X), _simd_ u32x16_splitlo_safe(Y)),\
//	_simd_u32x8_div_safe(_simd_u32x16_splithi_safe(X), _simd_ u32x16_splithi_safe(Y)))
...
//#else
//	#define _simd_u32x16_div(X,Y) _simd_u32x16_combine(\
...
//
//
//#if defined(_simd_u32x16_div_) && ! defined(_simd_u32x16_div_scalar_)
//	#define _simd_u32x16_div_scalar_(X,Y) _simd_u32x16_div_(X,_simd_u32x16_fill_scalar_(Y))
//	#define _simd_u32x16_div_scalar_instruction_set _simd_u32x16_div_instruction_set
//#endif
//#ifdef _simd_u32x16_div_scalar_
//	#define _simd_u32x16_div_scalar(X,Y) _simd_u32x16_div_scalar_(X,Y)
//	#define _simd_u32x16_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u32x16_div_scalar_instruction_set>()
//#else
//	#define _simd_u32x16_div_scalar(X,Y) _simd_u32x16_div_safe(X,_simd_u32x16_fill_scalar_safe(Y))
//	#define _simd_u32x16_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_u32x1_div_safe
//	#define _simd_u32x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_u32x32_div_safe(X,Y)_simd_u32x32_combine_safe(\
//	_simd_u32x16_div_safe(_simd_u32x32_splitlo_safe(X), _simd_ u32x32_splitlo_safe(Y)),\
//	_simd_u32x16_div_safe(_simd_u32x32_splithi_safe(X), _simd_ u32x32_splithi_safe(Y)))
...
//#else
//	#define _simd_u32x32_div(X,Y) _simd_u32x32_combine(\
...
//
//
//#if defined(_simd_u32x32_div_) && ! defined(_simd_u32x32_div_scalar_)
//	#define _simd_u32x32_div_scalar_(X,Y) _simd_u32x32_div_(X,_simd_u32x32_fill_scalar_(Y))
//	#define _simd_u32x32_div_scalar_instruction_set _simd_u32x32_div_instruction_set
//#endif
//#ifdef _simd_u32x32_div_scalar_
//	#define _simd_u32x32_div_scalar(X,Y) _simd_u32x32_div_scalar_(X,Y)
//	#define _simd_u32x32_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u32x32_div_scalar_instruction_set>()
//#else
//	#define _simd_u32x32_div_scalar(X,Y) _simd_u32x32_div_safe(X,_simd_u32x32_fill_scalar_safe(Y))
//	#define _simd_u32x32_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_u32x1_div_safe
//	#define _simd_u32x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_u32x64_div_safe(X,Y)_simd_u32x64_combine_safe(\
//	_simd_u32x32_div_safe(_simd_u32x64_splitlo_safe(X), _simd_ u32x64_splitlo_safe(Y)),\
//	_simd_u32x32_div_safe(_simd_u32x64_splithi_safe(X), _simd_ u32x64_splithi_safe(Y)))
...
//#else
//	#define _simd_u32x64_div(X,Y) _simd_u32x64_combine(\
...
//
//
//#if defined(_simd_u32x64_div_) && ! defined(_simd_u32x64_div_scalar_)
//	#define _simd_u32x64_div_scalar_(X,Y) _simd_u32x64_div_(X,_simd_u32x64_fill_scalar_(Y))
//	#define _simd_u32x64_div_scalar_instruction_set _simd_u32x64_div_instruction_set
//#endif
//#ifdef _simd_u32x64_div_scalar_
//	#define _simd_u32x64_div_scalar(X,Y) _simd_u32x64_div_scalar_(X,Y)
//	#define _simd_u32x64_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u32x64_div_scalar_instruction_set>()
//#else
//	#define _simd_u32x64_div_scalar(X,Y) _simd_u32x64_div_safe(X,_simd_u32x64_fill_scalar_safe(Y))
//	#define _simd_u32x64_div_scalar_enabled() true
//#endif
//
//// -- s16 --
//
//#ifndef _simd_s16x1_div_safe
//	#define _simd_s16x1_div_safe(X,Y) (X / Y)
//	#define _simd_s16x1_div_(X,Y) x1_div_safe(X,Y)
//	#define _simd_s16x1_div_instruction_set() anvil::simd::IS_NONE
//	#define _simd_s16x1_div_enabled() true
//#endif
//
//#define _simd_s16x2_div_safe(X,Y)_simd_s16x2_combine_safe(\
//	_simd_s16x1_div_safe(_simd_s16x2_splitlo_safe(X), _simd_ s16x2_splitlo_safe(Y)),\
//	_simd_s16x1_div_safe(_simd_s16x2_splithi_safe(X), _simd_ s16x2_splithi_safe(Y)))
...
//#else
//	#define _simd_s16x2_div(X,Y) _simd_s16x2_combine(\
...
//
//
//#if defined(_simd_s16x2_div_) && ! defined(_simd_s16x2_div_scalar_)
//	#define _simd_s16x2_div_scalar_(X,Y) _simd_s16x2_div_(X,_simd_s16x2_fill_scalar_(Y))
//	#define _simd_s16x2_div_scalar_instruction_set _simd_s16x2_div_instruction_set
//#endif
//#ifdef _simd_s16x2_div_scalar_
//	#define _simd_s16x2_div_scalar(X,Y) _simd_s16x2_div_scalar_(X,Y)
//	#define _simd_s16x2_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s16x2_div_scalar_instruction_set>()
//#else
//	#define _simd_s16x2_div_scalar(X,Y) _simd_s16x2_div_safe(X,_simd_s16x2_fill_scalar_safe(Y))
//	#define _simd_s16x2_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_s16x1_div_safe
//	#define _simd_s16x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_s16x4_div_safe(X,Y)_simd_s16x4_combine_safe(\
//	_simd_s16x2_div_safe(_simd_s16x4_splitlo_safe(X), _simd_ s16x4_splitlo_safe(Y)),\
//	_simd_s16x2_div_safe(_simd_s16x4_splithi_safe(X), _simd_ s16x4_splithi_safe(Y)))
...
//#else
//	#define _simd_s16x4_div(X,Y) _simd_s16x4_combine(\
...
//
//
//#if defined(_simd_s16x4_div_) && ! defined(_simd_s16x4_div_scalar_)
//	#define _simd_s16x4_div_scalar_(X,Y) _simd_s16x4_div_(X,_simd_s16x4_fill_scalar_(Y))
//	#define _simd_s16x4_div_scalar_instruction_set _simd_s16x4_div_instruction_set
//#endif
//#ifdef _simd_s16x4_div_scalar_
//	#define _simd_s16x4_div_scalar(X,Y) _simd_s16x4_div_scalar_(X,Y)
//	#define _simd_s16x4_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s16x4_div_scalar_instruction_set>()
//#else
//	#define _simd_s16x4_div_scalar(X,Y) _simd_s16x4_div_safe(X,_simd_s16x4_fill_scalar_safe(Y))
//	#define _simd_s16x4_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_s16x1_div_safe
//	#define _simd_s16x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_s16x8_div_safe(X,Y)_simd_s16x8_combine_safe(\
//	_simd_s16x4_div_safe(_simd_s16x8_splitlo_safe(X), _simd_ s16x8_splitlo_safe(Y)),\
//	_simd_s16x4_div_safe(_simd_s16x8_splithi_safe(X), _simd_ s16x8_splithi_safe(Y)))
...
//#else
//	#define _simd_s16x8_div(X,Y) _simd_s16x8_combine(\
...
//
//
//#if defined(_simd_s16x8_div_) && ! defined(_simd_s16x8_div_scalar_)
//	#define _simd_s16x8_div_scalar_(X,Y) _simd_s16x8_div_(X,_simd_s16x8_fill_scalar_(Y))
//	#define _simd_s16x8_div_scalar_instruction_set _simd_s16x8_div_instruction_set
//#endif
//#ifdef _simd_s16x8_div_scalar_
//	#define _simd_s16x8_div_scalar(X,Y) _simd_s16x8_div_scalar_(X,Y)
//	#define _simd_s16x8_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s16x8_div_scalar_instruction_set>()
//#else
//	#define _simd_s16x8_div_scalar(X,Y) _simd_s16x8_div_safe(X,_simd_s16x8_fill_scalar_safe(Y))
//	#define _simd_s16x8_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_s16x1_div_safe
//	#define _simd_s16x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_s16x16_div_safe(X,Y)_simd_s16x16_combine_safe(\
//	_simd_s16x8_div_safe(_simd_s16x16_splitlo_safe(X), _simd_ s16x16_splitlo_safe(Y)),\
//	_simd_s16x8_div_safe(_simd_s16x16_splithi_safe(X), _simd_ s16x16_splithi_safe(Y)))
...
//#else
//	#define _simd_s16x16_div(X,Y) _simd_s16x16_combine(\
...
//
//
//#if defined(_simd_s16x16_div_) && ! defined(_simd_s16x16_div_scalar_)
//	#define _simd_s16x16_div_scalar_(X,Y) _simd_s16x16_div_(X,_simd_s16x16_fill_scalar_(Y))
//	#define _simd_s16x16_div_scalar_instruction_set _simd_s16x16_div_instruction_set
//#endif
//#ifdef _simd_s16x16_div_scalar_
//	#define _simd_s16x16_div_scalar(X,Y) _simd_s16x16_div_scalar_(X,Y)
//	#define _simd_s16x16_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s16x16_div_scalar_instruction_set>()
//#else
//	#define _simd_s16x16_div_scalar(X,Y) _simd_s16x16_div_safe(X,_simd_s16x16_fill_scalar_safe(Y))
//	#define _simd_s16x16_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_s16x1_div_safe
//	#define _simd_s16x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_s16x32_div_safe(X,Y)_simd_s16x32_combine_safe(\
//	_simd_s16x16_div_safe(_simd_s16x32_splitlo_safe(X), _simd_ s16x32_splitlo_safe(Y)),\
//	_simd_s16x16_div_safe(_simd_s16x32_splithi_safe(X), _simd_ s16x32_splithi_safe(Y)))
...
//#else
//	#define _simd_s16x32_div(X,Y) _simd_s16x32_combine(\
...
//
//
//#if defined(_simd_s16x32_div_) && ! defined(_simd_s16x32_div_scalar_)
//	#define _simd_s16x32_div_scalar_(X,Y) _simd_s16x32_div_(X,_simd_s16x32_fill_scalar_(Y))
//	#define _simd_s16x32_div_scalar_instruction_set _simd_s16x32_div_instruction_set
//#endif
//#ifdef _simd_s16x32_div_scalar_
//	#define _simd_s16x32_div_scalar(X,Y) _simd_s16x32_div_scalar_(X,Y)
//	#define _simd_s16x32_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s16x32_div_scalar_instruction_set>()
//#else
//	#define _simd_s16x32_div_scalar(X,Y) _simd_s16x32_div_safe(X,_simd_s16x32_fill_scalar_safe(Y))
//	#define _simd_s16x32_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_s16x1_div_safe
//	#define _simd_s16x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_s16x64_div_safe(X,Y)_simd_s16x64_combine_safe(\
//	_simd_s16x32_div_safe(_simd_s16x64_splitlo_safe(X), _simd_ s16x64_splitlo_safe(Y)),\
//	_simd_s16x32_div_safe(_simd_s16x64_splithi_safe(X), _simd_ s16x64_splithi_safe(Y)))
...
//#else
//	#define _simd_s16x64_div(X,Y) _simd_s16x64_combine(\
...
//
//
//#if defined(_simd_s16x64_div_) && ! defined(_simd_s16x64_div_scalar_)
//	#define _simd_s16x64_div_scalar_(X,Y) _simd_s16x64_div_(X,_simd_s16x64_fill_scalar_(Y))
//	#define _simd_s16x64_div_scalar_instruction_set _simd_s16x64_div_instruction_set
//#endif
//#ifdef _simd_s16x64_div_scalar_
//	#define _simd_s16x64_div_scalar(X,Y) _simd_s16x64_div_scalar_(X,Y)
//	#define _simd_s16x64_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s16x64_div_scalar_instruction_set>()
//#else
//	#define _simd_s16x64_div_scalar(X,Y) _simd_s16x64_div_safe(X,_simd_s16x64_fill_scalar_safe(Y))
//	#define _simd_s16x64_div_scalar_enabled() true
//#endif
//
//// -- u16 --
//
//#ifndef _simd_u16x1_div_safe
//	#define _simd_u16x1_div_safe(X,Y) (X / Y)
//	#define _simd_u16x1_div_(X,Y) x1_div_safe(X,Y)
//	#define _simd_u16x1_div_instruction_set() anvil::simd::IS_NONE
//	#define _simd_u16x1_div_enabled() true
//#endif
//
//#define _simd_u16x2_div_safe(X,Y)_simd_u16x2_combine_safe(\
//	_simd_u16x1_div_safe(_simd_u16x2_splitlo_safe(X), _simd_ u16x2_splitlo_safe(Y)),\
//	_simd_u16x1_div_safe(_simd_u16x2_splithi_safe(X), _simd_ u16x2_splithi_safe(Y)))
...
//#else
//	#define _simd_u16x2_div(X,Y) _simd_u16x2_combine(\
...
//
//
//#if defined(_simd_u16x2_div_) && ! defined(_simd_u16x2_div_scalar_)
//	#define _simd_u16x2_div_scalar_(X,Y) _simd_u16x2_div_(X,_simd_u16x2_fill_scalar_(Y))
//	#define _simd_u16x2_div_scalar_instruction_set _simd_u16x2_div_instruction_set
//#endif
//#ifdef _simd_u16x2_div_scalar_
//	#define _simd_u16x2_div_scalar(X,Y) _simd_u16x2_div_scalar_(X,Y)
//	#define _simd_u16x2_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u16x2_div_scalar_instruction_set>()
//#else
//	#define _simd_u16x2_div_scalar(X,Y) _simd_u16x2_div_safe(X,_simd_u16x2_fill_scalar_safe(Y))
//	#define _simd_u16x2_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_u16x1_div_safe
//	#define _simd_u16x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_u16x4_div_safe(X,Y)_simd_u16x4_combine_safe(\
//	_simd_u16x2_div_safe(_simd_u16x4_splitlo_safe(X), _simd_ u16x4_splitlo_safe(Y)),\
//	_simd_u16x2_div_safe(_simd_u16x4_splithi_safe(X), _simd_ u16x4_splithi_safe(Y)))
...
//#else
//	#define _simd_u16x4_div(X,Y) _simd_u16x4_combine(\
...
//
//
//#if defined(_simd_u16x4_div_) && ! defined(_simd_u16x4_div_scalar_)
//	#define _simd_u16x4_div_scalar_(X,Y) _simd_u16x4_div_(X,_simd_u16x4_fill_scalar_(Y))
//	#define _simd_u16x4_div_scalar_instruction_set _simd_u16x4_div_instruction_set
//#endif
//#ifdef _simd_u16x4_div_scalar_
//	#define _simd_u16x4_div_scalar(X,Y) _simd_u16x4_div_scalar_(X,Y)
//	#define _simd_u16x4_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u16x4_div_scalar_instruction_set>()
//#else
//	#define _simd_u16x4_div_scalar(X,Y) _simd_u16x4_div_safe(X,_simd_u16x4_fill_scalar_safe(Y))
//	#define _simd_u16x4_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_u16x1_div_safe
//	#define _simd_u16x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_u16x8_div_safe(X,Y)_simd_u16x8_combine_safe(\
//	_simd_u16x4_div_safe(_simd_u16x8_splitlo_safe(X), _simd_ u16x8_splitlo_safe(Y)),\
//	_simd_u16x4_div_safe(_simd_u16x8_splithi_safe(X), _simd_ u16x8_splithi_safe(Y)))
...
//#else
//	#define _simd_u16x8_div(X,Y) _simd_u16x8_combine(\
...
//
//
//#if defined(_simd_u16x8_div_) && ! defined(_simd_u16x8_div_scalar_)
//	#define _simd_u16x8_div_scalar_(X,Y) _simd_u16x8_div_(X,_simd_u16x8_fill_scalar_(Y))
//	#define _simd_u16x8_div_scalar_instruction_set _simd_u16x8_div_instruction_set
//#endif
//#ifdef _simd_u16x8_div_scalar_
//	#define _simd_u16x8_div_scalar(X,Y) _simd_u16x8_div_scalar_(X,Y)
//	#define _simd_u16x8_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u16x8_div_scalar_instruction_set>()
//#else
//	#define _simd_u16x8_div_scalar(X,Y) _simd_u16x8_div_safe(X,_simd_u16x8_fill_scalar_safe(Y))
//	#define _simd_u16x8_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_u16x1_div_safe
//	#define _simd_u16x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_u16x16_div_safe(X,Y)_simd_u16x16_combine_safe(\
//	_simd_u16x8_div_safe(_simd_u16x16_splitlo_safe(X), _simd_ u16x16_splitlo_safe(Y)),\
//	_simd_u16x8_div_safe(_simd_u16x16_splithi_safe(X), _simd_ u16x16_splithi_safe(Y)))
...
//#else
//	#define _simd_u16x16_div(X,Y) _simd_u16x16_combine(\
...
//
//
//#if defined(_simd_u16x16_div_) && ! defined(_simd_u16x16_div_scalar_)
//	#define _simd_u16x16_div_scalar_(X,Y) _simd_u16x16_div_(X,_simd_u16x16_fill_scalar_(Y))
//	#define _simd_u16x16_div_scalar_instruction_set _simd_u16x16_div_instruction_set
//#endif
//#ifdef _simd_u16x16_div_scalar_
//	#define _simd_u16x16_div_scalar(X,Y) _simd_u16x16_div_scalar_(X,Y)
//	#define _simd_u16x16_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u16x16_div_scalar_instruction_set>()
//#else
//	#define _simd_u16x16_div_scalar(X,Y) _simd_u16x16_div_safe(X,_simd_u16x16_fill_scalar_safe(Y))
//	#define _simd_u16x16_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_u16x1_div_safe
//	#define _simd_u16x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_u16x32_div_safe(X,Y)_simd_u16x32_combine_safe(\
//	_simd_u16x16_div_safe(_simd_u16x32_splitlo_safe(X), _simd_ u16x32_splitlo_safe(Y)),\
//	_simd_u16x16_div_safe(_simd_u16x32_splithi_safe(X), _simd_ u16x32_splithi_safe(Y)))
...
//#else
//	#define _simd_u16x32_div(X,Y) _simd_u16x32_combine(\
...
//
//
//#if defined(_simd_u16x32_div_) && ! defined(_simd_u16x32_div_scalar_)
//	#define _simd_u16x32_div_scalar_(X,Y) _simd_u16x32_div_(X,_simd_u16x32_fill_scalar_(Y))
//	#define _simd_u16x32_div_scalar_instruction_set _simd_u16x32_div_instruction_set
//#endif
//#ifdef _simd_u16x32_div_scalar_
//	#define _simd_u16x32_div_scalar(X,Y) _simd_u16x32_div_scalar_(X,Y)
//	#define _simd_u16x32_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u16x32_div_scalar_instruction_set>()
//#else
//	#define _simd_u16x32_div_scalar(X,Y) _simd_u16x32_div_safe(X,_simd_u16x32_fill_scalar_safe(Y))
//	#define _simd_u16x32_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_u16x1_div_safe
//	#define _simd_u16x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_u16x64_div_safe(X,Y)_simd_u16x64_combine_safe(\
//	_simd_u16x32_div_safe(_simd_u16x64_splitlo_safe(X), _simd_ u16x64_splitlo_safe(Y)),\
//	_simd_u16x32_div_safe(_simd_u16x64_splithi_safe(X), _simd_ u16x64_splithi_safe(Y)))
...
//#else
//	#define _simd_u16x64_div(X,Y) _simd_u16x64_combine(\
...
//
//
//#if defined(_simd_u16x64_div_) && ! defined(_simd_u16x64_div_scalar_)
//	#define _simd_u16x64_div_scalar_(X,Y) _simd_u16x64_div_(X,_simd_u16x64_fill_scalar_(Y))
//	#define _simd_u16x64_div_scalar_instruction_set _simd_u16x64_div_instruction_set
//#endif
//#ifdef _simd_u16x64_div_scalar_
//	#define _simd_u16x64_div_scalar(X,Y) _simd_u16x64_div_scalar_(X,Y)
//	#define _simd_u16x64_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u16x64_div_scalar_instruction_set>()
//#else
//	#define _simd_u16x64_div_scalar(X,Y) _simd_u16x64_div_safe(X,_simd_u16x64_fill_scalar_safe(Y))
//	#define _simd_u16x64_div_scalar_enabled() true
//#endif
//
//// -- s8 --
//
//#ifndef _simd_s8x1_div_safe
//	#define _simd_s8x1_div_safe(X,Y) (X / Y)
//	#define _simd_s8x1_div_(X,Y) x1_div_safe(X,Y)
//	#define _simd_s8x1_div_instruction_set() anvil::simd::IS_NONE
//	#define _simd_s8x1_div_enabled() true
//#endif
//
//#define _simd_s8x2_div_safe(X,Y)_simd_s8x2_combine_safe(\
//	_simd_s8x1_div_safe(_simd_s8x2_splitlo_safe(X), _simd_ s8x2_splitlo_safe(Y)),\
//	_simd_s8x1_div_safe(_simd_s8x2_splithi_safe(X), _simd_ s8x2_splithi_safe(Y)))
...
//#else
//	#define _simd_s8x2_div(X,Y) _simd_s8x2_combine(\
...
//
//
//#if defined(_simd_s8x2_div_) && ! defined(_simd_s8x2_div_scalar_)
//	#define _simd_s8x2_div_scalar_(X,Y) _simd_s8x2_div_(X,_simd_s8x2_fill_scalar_(Y))
//	#define _simd_s8x2_div_scalar_instruction_set _simd_s8x2_div_instruction_set
//#endif
//#ifdef _simd_s8x2_div_scalar_
//	#define _simd_s8x2_div_scalar(X,Y) _simd_s8x2_div_scalar_(X,Y)
//	#define _simd_s8x2_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s8x2_div_scalar_instruction_set>()
//#else
//	#define _simd_s8x2_div_scalar(X,Y) _simd_s8x2_div_safe(X,_simd_s8x2_fill_scalar_safe(Y))
//	#define _simd_s8x2_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_s8x1_div_safe
//	#define _simd_s8x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_s8x4_div_safe(X,Y)_simd_s8x4_combine_safe(\
//	_simd_s8x2_div_safe(_simd_s8x4_splitlo_safe(X), _simd_ s8x4_splitlo_safe(Y)),\
//	_simd_s8x2_div_safe(_simd_s8x4_splithi_safe(X), _simd_ s8x4_splithi_safe(Y)))
...
//#else
//	#define _simd_s8x4_div(X,Y) _simd_s8x4_combine(\
...
//
//
//#if defined(_simd_s8x4_div_) && ! defined(_simd_s8x4_div_scalar_)
//	#define _simd_s8x4_div_scalar_(X,Y) _simd_s8x4_div_(X,_simd_s8x4_fill_scalar_(Y))
//	#define _simd_s8x4_div_scalar_instruction_set _simd_s8x4_div_instruction_set
//#endif
//#ifdef _simd_s8x4_div_scalar_
//	#define _simd_s8x4_div_scalar(X,Y) _simd_s8x4_div_scalar_(X,Y)
//	#define _simd_s8x4_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s8x4_div_scalar_instruction_set>()
//#else
//	#define _simd_s8x4_div_scalar(X,Y) _simd_s8x4_div_safe(X,_simd_s8x4_fill_scalar_safe(Y))
//	#define _simd_s8x4_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_s8x1_div_safe
//	#define _simd_s8x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_s8x8_div_safe(X,Y)_simd_s8x8_combine_safe(\
//	_simd_s8x4_div_safe(_simd_s8x8_splitlo_safe(X), _simd_ s8x8_splitlo_safe(Y)),\
//	_simd_s8x4_div_safe(_simd_s8x8_splithi_safe(X), _simd_ s8x8_splithi_safe(Y)))
...
//#else
//	#define _simd_s8x8_div(X,Y) _simd_s8x8_combine(\
...
//
//
//#if defined(_simd_s8x8_div_) && ! defined(_simd_s8x8_div_scalar_)
//	#define _simd_s8x8_div_scalar_(X,Y) _simd_s8x8_div_(X,_simd_s8x8_fill_scalar_(Y))
//	#define _simd_s8x8_div_scalar_instruction_set _simd_s8x8_div_instruction_set
//#endif
//#ifdef _simd_s8x8_div_scalar_
//	#define _simd_s8x8_div_scalar(X,Y) _simd_s8x8_div_scalar_(X,Y)
//	#define _simd_s8x8_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s8x8_div_scalar_instruction_set>()
//#else
//	#define _simd_s8x8_div_scalar(X,Y) _simd_s8x8_div_safe(X,_simd_s8x8_fill_scalar_safe(Y))
//	#define _simd_s8x8_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_s8x1_div_safe
//	#define _simd_s8x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_s8x16_div_safe(X,Y)_simd_s8x16_combine_safe(\
//	_simd_s8x8_div_safe(_simd_s8x16_splitlo_safe(X), _simd_ s8x16_splitlo_safe(Y)),\
//	_simd_s8x8_div_safe(_simd_s8x16_splithi_safe(X), _simd_ s8x16_splithi_safe(Y)))
...
//#else
//	#define _simd_s8x16_div(X,Y) _simd_s8x16_combine(\
...
//
//
//#if defined(_simd_s8x16_div_) && ! defined(_simd_s8x16_div_scalar_)
//	#define _simd_s8x16_div_scalar_(X,Y) _simd_s8x16_div_(X,_simd_s8x16_fill_scalar_(Y))
//	#define _simd_s8x16_div_scalar_instruction_set _simd_s8x16_div_instruction_set
//#endif
//#ifdef _simd_s8x16_div_scalar_
//	#define _simd_s8x16_div_scalar(X,Y) _simd_s8x16_div_scalar_(X,Y)
//	#define _simd_s8x16_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s8x16_div_scalar_instruction_set>()
//#else
//	#define _simd_s8x16_div_scalar(X,Y) _simd_s8x16_div_safe(X,_simd_s8x16_fill_scalar_safe(Y))
//	#define _simd_s8x16_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_s8x1_div_safe
//	#define _simd_s8x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_s8x32_div_safe(X,Y)_simd_s8x32_combine_safe(\
//	_simd_s8x16_div_safe(_simd_s8x32_splitlo_safe(X), _simd_ s8x32_splitlo_safe(Y)),\
//	_simd_s8x16_div_safe(_simd_s8x32_splithi_safe(X), _simd_ s8x32_splithi_safe(Y)))
...
//#else
//	#define _simd_s8x32_div(X,Y) _simd_s8x32_combine(\
...
//
//
//#if defined(_simd_s8x32_div_) && ! defined(_simd_s8x32_div_scalar_)
//	#define _simd_s8x32_div_scalar_(X,Y) _simd_s8x32_div_(X,_simd_s8x32_fill_scalar_(Y))
//	#define _simd_s8x32_div_scalar_instruction_set _simd_s8x32_div_instruction_set
//#endif
//#ifdef _simd_s8x32_div_scalar_
//	#define _simd_s8x32_div_scalar(X,Y) _simd_s8x32_div_scalar_(X,Y)
//	#define _simd_s8x32_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s8x32_div_scalar_instruction_set>()
//#else
//	#define _simd_s8x32_div_scalar(X,Y) _simd_s8x32_div_safe(X,_simd_s8x32_fill_scalar_safe(Y))
//	#define _simd_s8x32_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_s8x1_div_safe
//	#define _simd_s8x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_s8x64_div_safe(X,Y)_simd_s8x64_combine_safe(\
//	_simd_s8x32_div_safe(_simd_s8x64_splitlo_safe(X), _simd_ s8x64_splitlo_safe(Y)),\
//	_simd_s8x32_div_safe(_simd_s8x64_splithi_safe(X), _simd_ s8x64_splithi_safe(Y)))
...
//#else
//	#define _simd_s8x64_div(X,Y) _simd_s8x64_combine(\
...
//
//
//#if defined(_simd_s8x64_div_) && ! defined(_simd_s8x64_div_scalar_)
//	#define _simd_s8x64_div_scalar_(X,Y) _simd_s8x64_div_(X,_simd_s8x64_fill_scalar_(Y))
//	#define _simd_s8x64_div_scalar_instruction_set _simd_s8x64_div_instruction_set
//#endif
//#ifdef _simd_s8x64_div_scalar_
//	#define _simd_s8x64_div_scalar(X,Y) _simd_s8x64_div_scalar_(X,Y)
//	#define _simd_s8x64_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s8x64_div_scalar_instruction_set>()
//#else
//	#define _simd_s8x64_div_scalar(X,Y) _simd_s8x64_div_safe(X,_simd_s8x64_fill_scalar_safe(Y))
//	#define _simd_s8x64_div_scalar_enabled() true
//#endif
//
//// -- u8 --
//
//#ifndef _simd_u8x1_div_safe
//	#define _simd_u8x1_div_safe(X,Y) (X / Y)
//	#define _simd_u8x1_div_(X,Y) x1_div_safe(X,Y)
//	#define _simd_u8x1_div_instruction_set() anvil::simd::IS_NONE
//	#define _simd_u8x1_div_enabled() true
//#endif
//
//#define _simd_u8x2_div_safe(X,Y)_simd_u8x2_combine_safe(\
//	_simd_u8x1_div_safe(_simd_u8x2_splitlo_safe(X), _simd_ u8x2_splitlo_safe(Y)),\
//	_simd_u8x1_div_safe(_simd_u8x2_splithi_safe(X), _simd_ u8x2_splithi_safe(Y)))
...
//#else
//	#define _simd_u8x2_div(X,Y) _simd_u8x2_combine(\
...
//
//
//#if defined(_simd_u8x2_div_) && ! defined(_simd_u8x2_div_scalar_)
//	#define _simd_u8x2_div_scalar_(X,Y) _simd_u8x2_div_(X,_simd_u8x2_fill_scalar_(Y))
//	#define _simd_u8x2_div_scalar_instruction_set _simd_u8x2_div_instruction_set
//#endif
//#ifdef _simd_u8x2_div_scalar_
//	#define _simd_u8x2_div_scalar(X,Y) _simd_u8x2_div_scalar_(X,Y)
//	#define _simd_u8x2_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u8x2_div_scalar_instruction_set>()
//#else
//	#define _simd_u8x2_div_scalar(X,Y) _simd_u8x2_div_safe(X,_simd_u8x2_fill_scalar_safe(Y))
//	#define _simd_u8x2_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_u8x1_div_safe
//	#define _simd_u8x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_u8x4_div_safe(X,Y)_simd_u8x4_combine_safe(\
//	_simd_u8x2_div_safe(_simd_u8x4_splitlo_safe(X), _simd_ u8x4_splitlo_safe(Y)),\
//	_simd_u8x2_div_safe(_simd_u8x4_splithi_safe(X), _simd_ u8x4_splithi_safe(Y)))
...
//#else
//	#define _simd_u8x4_div(X,Y) _simd_u8x4_combine(\
...
//
//
//#if defined(_simd_u8x4_div_) && ! defined(_simd_u8x4_div_scalar_)
//	#define _simd_u8x4_div_scalar_(X,Y) _simd_u8x4_div_(X,_simd_u8x4_fill_scalar_(Y))
//	#define _simd_u8x4_div_scalar_instruction_set _simd_u8x4_div_instruction_set
//#endif
//#ifdef _simd_u8x4_div_scalar_
//	#define _simd_u8x4_div_scalar(X,Y) _simd_u8x4_div_scalar_(X,Y)
//	#define _simd_u8x4_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u8x4_div_scalar_instruction_set>()
//#else
//	#define _simd_u8x4_div_scalar(X,Y) _simd_u8x4_div_safe(X,_simd_u8x4_fill_scalar_safe(Y))
//	#define _simd_u8x4_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_u8x1_div_safe
//	#define _simd_u8x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_u8x8_div_safe(X,Y)_simd_u8x8_combine_safe(\
//	_simd_u8x4_div_safe(_simd_u8x8_splitlo_safe(X), _simd_ u8x8_splitlo_safe(Y)),\
//	_simd_u8x4_div_safe(_simd_u8x8_splithi_safe(X), _simd_ u8x8_splithi_safe(Y)))
...
//#else
//	#define _simd_u8x8_div(X,Y) _simd_u8x8_combine(\
...
//
//
//#if defined(_simd_u8x8_div_) && ! defined(_simd_u8x8_div_scalar_)
//	#define _simd_u8x8_div_scalar_(X,Y) _simd_u8x8_div_(X,_simd_u8x8_fill_scalar_(Y))
//	#define _simd_u8x8_div_scalar_instruction_set _simd_u8x8_div_instruction_set
//#endif
//#ifdef _simd_u8x8_div_scalar_
//	#define _simd_u8x8_div_scalar(X,Y) _simd_u8x8_div_scalar_(X,Y)
//	#define _simd_u8x8_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u8x8_div_scalar_instruction_set>()
//#else
//	#define _simd_u8x8_div_scalar(X,Y) _simd_u8x8_div_safe(X,_simd_u8x8_fill_scalar_safe(Y))
//	#define _simd_u8x8_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_u8x1_div_safe
//	#define _simd_u8x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_u8x16_div_safe(X,Y)_simd_u8x16_combine_safe(\
//	_simd_u8x8_div_safe(_simd_u8x16_splitlo_safe(X), _simd_ u8x16_splitlo_safe(Y)),\
//	_simd_u8x8_div_safe(_simd_u8x16_splithi_safe(X), _simd_ u8x16_splithi_safe(Y)))
...
//#else
//	#define _simd_u8x16_div(X,Y) _simd_u8x16_combine(\
...
//
//
//#if defined(_simd_u8x16_div_) && ! defined(_simd_u8x16_div_scalar_)
//	#define _simd_u8x16_div_scalar_(X,Y) _simd_u8x16_div_(X,_simd_u8x16_fill_scalar_(Y))
//	#define _simd_u8x16_div_scalar_instruction_set _simd_u8x16_div_instruction_set
//#endif
//#ifdef _simd_u8x16_div_scalar_
//	#define _simd_u8x16_div_scalar(X,Y) _simd_u8x16_div_scalar_(X,Y)
//	#define _simd_u8x16_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u8x16_div_scalar_instruction_set>()
//#else
//	#define _simd_u8x16_div_scalar(X,Y) _simd_u8x16_div_safe(X,_simd_u8x16_fill_scalar_safe(Y))
//	#define _simd_u8x16_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_u8x1_div_safe
//	#define _simd_u8x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_u8x32_div_safe(X,Y)_simd_u8x32_combine_safe(\
//	_simd_u8x16_div_safe(_simd_u8x32_splitlo_safe(X), _simd_ u8x32_splitlo_safe(Y)),\
//	_simd_u8x16_div_safe(_simd_u8x32_splithi_safe(X), _simd_ u8x32_splithi_safe(Y)))
...
//#else
//	#define _simd_u8x32_div(X,Y) _simd_u8x32_combine(\
...
//
//
//#if defined(_simd_u8x32_div_) && ! defined(_simd_u8x32_div_scalar_)
//	#define _simd_u8x32_div_scalar_(X,Y) _simd_u8x32_div_(X,_simd_u8x32_fill_scalar_(Y))
//	#define _simd_u8x32_div_scalar_instruction_set _simd_u8x32_div_instruction_set
//#endif
//#ifdef _simd_u8x32_div_scalar_
//	#define _simd_u8x32_div_scalar(X,Y) _simd_u8x32_div_scalar_(X,Y)
//	#define _simd_u8x32_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u8x32_div_scalar_instruction_set>()
//#else
//	#define _simd_u8x32_div_scalar(X,Y) _simd_u8x32_div_safe(X,_simd_u8x32_fill_scalar_safe(Y))
//	#define _simd_u8x32_div_scalar_enabled() true
//#endif
//
//#ifndef _simd_u8x1_div_safe
//	#define _simd_u8x1_div_safe(X,Y) (X / Y)
...
//#endif
//
//#define _simd_u8x64_div_safe(X,Y)_simd_u8x64_combine_safe(\
//	_simd_u8x32_div_safe(_simd_u8x64_splitlo_safe(X), _simd_ u8x64_splitlo_safe(Y)),\
//	_simd_u8x32_div_safe(_simd_u8x64_splithi_safe(X), _simd_ u8x64_splithi_safe(Y)))
...
//#else
//	#define _simd_u8x64_div(X,Y) _simd_u8x64_combine(\
...
//
//
//#if defined(_simd_u8x64_div_) && ! defined(_simd_u8x64_div_scalar_)
//	#define _simd_u8x64_div_scalar_(X,Y) _simd_u8x64_div_(X,_simd_u8x64_fill_scalar_(Y))
//	#define _simd_u8x64_div_scalar_instruction_set _simd_u8x64_div_instruction_set
//#endif
//#ifdef _simd_u8x64_div_scalar_
//	#define _simd_u8x64_div_scalar(X,Y) _simd_u8x64_div_scalar_(X,Y)
//	#define _simd_u8x64_div_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u8x64_div_scalar_instruction_set>()
//#else
//	#define _simd_u8x64_div_scalar(X,Y) _simd_u8x64_div_safe(X,_simd_u8x64_fill_scalar_safe(Y))
//	#define _simd_u8x64_div_scalar_enabled() true
//#endif
//
