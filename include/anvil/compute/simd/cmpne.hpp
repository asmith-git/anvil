...
#ifndef ANVIL_COMPUTE_SIMD_CMPNE_HPP
#define ANVIL_COMPUTE_SIMD_CMPNE_HPP
...
namespace anvil {
	namespace detail {
		template<class T>
		using VectorCmpNe = VectorArith<ANVIL_VECTOR_ARITH_CMPNE, T>;
	}
}
...
namespace anvil {
	...
	static inline T VectorCmpNe(const T& a, const T& b) throw() {
		return detail::VectorCmpNe<T>::Execute<instruction_set>(a, b);
	}

	template<uint64_t instruction_set = ASM_MINIMUM, class T>
	static inline T VectorCmpNe(const T& a, const T& b, const T& src, const uint64_t mask) throw() {
		return detail::VectorCmpNe<T>::ExecuteRuntimeMask<instruction_set>(a, b, src, mask);
	}

	template<uint64_t instruction_set = ASM_MINIMUM, class T>
	static inline T VectorCmpNe(const T& a, const T& b, const T& src, const Bitfield128 mask) throw() {
		return detail::VectorCmpNe<T>::ExecuteRuntimeMask<instruction_set>(a, b, src, mask);
	}

	template<uint64_t instruction_set = ASM_MINIMUM, class T>
	static inline T VectorCmpNe(const T& a, const T& b, const T& src, const Bitfield256 mask) throw() {
		return detail::VectorCmpNe<T>::ExecuteRuntimeMask<instruction_set>(a, b, src, mask);
	}

	template<uint64_t mask, uint64_t instruction_set = ASM_MINIMUM, class T>
	static inline T VectorCmpNe(const T& a, const T& b, const T& src) throw() {
		return detail::VectorCmpNes<T>::ExecuteCompiletimeMask<mask, instruction_set>(a, b, src);
	}
}
...
//#else
//	#define _simd_f64x2_cmpne(X,Y) _simd_f64x2_combine(\
...
//
//
//#if defined(_simd_f64x2_cmpne_) && ! defined(_simd_f64x2_cmpne_scalar_)
//	#define _simd_f64x2_cmpne_scalar_(X,Y) _simd_f64x2_cmpne_(X,_simd_f64x2_fill_scalar_(Y))
//	#define _simd_f64x2_cmpne_scalar_instruction_set _simd_f64x2_cmpne_instruction_set
//#endif
//#ifdef _simd_f64x2_cmpne_scalar_
//	#define _simd_f64x2_cmpne_scalar(X,Y) _simd_f64x2_cmpne_scalar_(X,Y)
//	#define _simd_f64x2_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f64x2_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_f64x2_cmpne_scalar(X,Y) _simd_f64x2_cmpne_safe(X,_simd_f64x2_fill_scalar_safe(Y))
//	#define _simd_f64x2_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_f64x1_cmpne_safe
//	#define _simd_f64x1_cmpne_safe(X,Y) static_cast<_simd_f64x1>(X != Y)
...
//#else
//	#define _simd_f64x4_cmpne(X,Y) _simd_f64x4_combine(\
...
//
//
//#if defined(_simd_f64x4_cmpne_) && ! defined(_simd_f64x4_cmpne_scalar_)
//	#define _simd_f64x4_cmpne_scalar_(X,Y) _simd_f64x4_cmpne_(X,_simd_f64x4_fill_scalar_(Y))
//	#define _simd_f64x4_cmpne_scalar_instruction_set _simd_f64x4_cmpne_instruction_set
//#endif
//#ifdef _simd_f64x4_cmpne_scalar_
//	#define _simd_f64x4_cmpne_scalar(X,Y) _simd_f64x4_cmpne_scalar_(X,Y)
//	#define _simd_f64x4_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f64x4_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_f64x4_cmpne_scalar(X,Y) _simd_f64x4_cmpne_safe(X,_simd_f64x4_fill_scalar_safe(Y))
//	#define _simd_f64x4_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_f64x1_cmpne_safe
//	#define _simd_f64x1_cmpne_safe(X,Y) static_cast<_simd_f64x1>(X != Y)
...
//#else
//	#define _simd_f64x8_cmpne(X,Y) _simd_f64x8_combine(\
...
//
//
//#if defined(_simd_f64x8_cmpne_) && ! defined(_simd_f64x8_cmpne_scalar_)
//	#define _simd_f64x8_cmpne_scalar_(X,Y) _simd_f64x8_cmpne_(X,_simd_f64x8_fill_scalar_(Y))
//	#define _simd_f64x8_cmpne_scalar_instruction_set _simd_f64x8_cmpne_instruction_set
//#endif
//#ifdef _simd_f64x8_cmpne_scalar_
//	#define _simd_f64x8_cmpne_scalar(X,Y) _simd_f64x8_cmpne_scalar_(X,Y)
//	#define _simd_f64x8_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f64x8_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_f64x8_cmpne_scalar(X,Y) _simd_f64x8_cmpne_safe(X,_simd_f64x8_fill_scalar_safe(Y))
//	#define _simd_f64x8_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_f64x1_cmpne_safe
//	#define _simd_f64x1_cmpne_safe(X,Y) static_cast<_simd_f64x1>(X != Y)
...
//#else
//	#define _simd_f64x16_cmpne(X,Y) _simd_f64x16_combine(\
...
//
//
//#if defined(_simd_f64x16_cmpne_) && ! defined(_simd_f64x16_cmpne_scalar_)
//	#define _simd_f64x16_cmpne_scalar_(X,Y) _simd_f64x16_cmpne_(X,_simd_f64x16_fill_scalar_(Y))
//	#define _simd_f64x16_cmpne_scalar_instruction_set _simd_f64x16_cmpne_instruction_set
//#endif
//#ifdef _simd_f64x16_cmpne_scalar_
//	#define _simd_f64x16_cmpne_scalar(X,Y) _simd_f64x16_cmpne_scalar_(X,Y)
//	#define _simd_f64x16_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f64x16_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_f64x16_cmpne_scalar(X,Y) _simd_f64x16_cmpne_safe(X,_simd_f64x16_fill_scalar_safe(Y))
//	#define _simd_f64x16_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_f64x1_cmpne_safe
//	#define _simd_f64x1_cmpne_safe(X,Y) static_cast<_simd_f64x1>(X != Y)
...
//#else
//	#define _simd_f64x32_cmpne(X,Y) _simd_f64x32_combine(\
...
//
//
//#if defined(_simd_f64x32_cmpne_) && ! defined(_simd_f64x32_cmpne_scalar_)
//	#define _simd_f64x32_cmpne_scalar_(X,Y) _simd_f64x32_cmpne_(X,_simd_f64x32_fill_scalar_(Y))
//	#define _simd_f64x32_cmpne_scalar_instruction_set _simd_f64x32_cmpne_instruction_set
//#endif
//#ifdef _simd_f64x32_cmpne_scalar_
//	#define _simd_f64x32_cmpne_scalar(X,Y) _simd_f64x32_cmpne_scalar_(X,Y)
//	#define _simd_f64x32_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f64x32_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_f64x32_cmpne_scalar(X,Y) _simd_f64x32_cmpne_safe(X,_simd_f64x32_fill_scalar_safe(Y))
//	#define _simd_f64x32_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_f64x1_cmpne_safe
//	#define _simd_f64x1_cmpne_safe(X,Y) static_cast<_simd_f64x1>(X != Y)
...
//#else
//	#define _simd_f64x64_cmpne(X,Y) _simd_f64x64_combine(\
...
//
//
//#if defined(_simd_f64x64_cmpne_) && ! defined(_simd_f64x64_cmpne_scalar_)
//	#define _simd_f64x64_cmpne_scalar_(X,Y) _simd_f64x64_cmpne_(X,_simd_f64x64_fill_scalar_(Y))
//	#define _simd_f64x64_cmpne_scalar_instruction_set _simd_f64x64_cmpne_instruction_set
//#endif
//#ifdef _simd_f64x64_cmpne_scalar_
//	#define _simd_f64x64_cmpne_scalar(X,Y) _simd_f64x64_cmpne_scalar_(X,Y)
//	#define _simd_f64x64_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f64x64_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_f64x64_cmpne_scalar(X,Y) _simd_f64x64_cmpne_safe(X,_simd_f64x64_fill_scalar_safe(Y))
//	#define _simd_f64x64_cmpne_scalar_enabled() true
//#endif
//
//// -- f32 --
//
...
//#else
//	#define _simd_f32x2_cmpne(X,Y) _simd_f32x2_combine(\
...
//
//
//#if defined(_simd_f32x2_cmpne_) && ! defined(_simd_f32x2_cmpne_scalar_)
//	#define _simd_f32x2_cmpne_scalar_(X,Y) _simd_f32x2_cmpne_(X,_simd_f32x2_fill_scalar_(Y))
//	#define _simd_f32x2_cmpne_scalar_instruction_set _simd_f32x2_cmpne_instruction_set
//#endif
//#ifdef _simd_f32x2_cmpne_scalar_
//	#define _simd_f32x2_cmpne_scalar(X,Y) _simd_f32x2_cmpne_scalar_(X,Y)
//	#define _simd_f32x2_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f32x2_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_f32x2_cmpne_scalar(X,Y) _simd_f32x2_cmpne_safe(X,_simd_f32x2_fill_scalar_safe(Y))
//	#define _simd_f32x2_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_f32x1_cmpne_safe
//	#define _simd_f32x1_cmpne_safe(X,Y) static_cast<_simd_f32x1>(X != Y)
...
//#else
//	#define _simd_f32x4_cmpne(X,Y) _simd_f32x4_combine(\
...
//
//
//#if defined(_simd_f32x4_cmpne_) && ! defined(_simd_f32x4_cmpne_scalar_)
//	#define _simd_f32x4_cmpne_scalar_(X,Y) _simd_f32x4_cmpne_(X,_simd_f32x4_fill_scalar_(Y))
//	#define _simd_f32x4_cmpne_scalar_instruction_set _simd_f32x4_cmpne_instruction_set
//#endif
//#ifdef _simd_f32x4_cmpne_scalar_
//	#define _simd_f32x4_cmpne_scalar(X,Y) _simd_f32x4_cmpne_scalar_(X,Y)
//	#define _simd_f32x4_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f32x4_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_f32x4_cmpne_scalar(X,Y) _simd_f32x4_cmpne_safe(X,_simd_f32x4_fill_scalar_safe(Y))
//	#define _simd_f32x4_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_f32x1_cmpne_safe
//	#define _simd_f32x1_cmpne_safe(X,Y) static_cast<_simd_f32x1>(X != Y)
...
//#else
//	#define _simd_f32x8_cmpne(X,Y) _simd_f32x8_combine(\
...
//
//
//#if defined(_simd_f32x8_cmpne_) && ! defined(_simd_f32x8_cmpne_scalar_)
//	#define _simd_f32x8_cmpne_scalar_(X,Y) _simd_f32x8_cmpne_(X,_simd_f32x8_fill_scalar_(Y))
//	#define _simd_f32x8_cmpne_scalar_instruction_set _simd_f32x8_cmpne_instruction_set
//#endif
//#ifdef _simd_f32x8_cmpne_scalar_
//	#define _simd_f32x8_cmpne_scalar(X,Y) _simd_f32x8_cmpne_scalar_(X,Y)
//	#define _simd_f32x8_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f32x8_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_f32x8_cmpne_scalar(X,Y) _simd_f32x8_cmpne_safe(X,_simd_f32x8_fill_scalar_safe(Y))
//	#define _simd_f32x8_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_f32x1_cmpne_safe
//	#define _simd_f32x1_cmpne_safe(X,Y) static_cast<_simd_f32x1>(X != Y)
...
//#else
//	#define _simd_f32x16_cmpne(X,Y) _simd_f32x16_combine(\
...
//
//
//#if defined(_simd_f32x16_cmpne_) && ! defined(_simd_f32x16_cmpne_scalar_)
//	#define _simd_f32x16_cmpne_scalar_(X,Y) _simd_f32x16_cmpne_(X,_simd_f32x16_fill_scalar_(Y))
//	#define _simd_f32x16_cmpne_scalar_instruction_set _simd_f32x16_cmpne_instruction_set
//#endif
//#ifdef _simd_f32x16_cmpne_scalar_
//	#define _simd_f32x16_cmpne_scalar(X,Y) _simd_f32x16_cmpne_scalar_(X,Y)
//	#define _simd_f32x16_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f32x16_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_f32x16_cmpne_scalar(X,Y) _simd_f32x16_cmpne_safe(X,_simd_f32x16_fill_scalar_safe(Y))
//	#define _simd_f32x16_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_f32x1_cmpne_safe
//	#define _simd_f32x1_cmpne_safe(X,Y) static_cast<_simd_f32x1>(X != Y)
...
//#else
//	#define _simd_f32x32_cmpne(X,Y) _simd_f32x32_combine(\
...
//
//
//#if defined(_simd_f32x32_cmpne_) && ! defined(_simd_f32x32_cmpne_scalar_)
//	#define _simd_f32x32_cmpne_scalar_(X,Y) _simd_f32x32_cmpne_(X,_simd_f32x32_fill_scalar_(Y))
//	#define _simd_f32x32_cmpne_scalar_instruction_set _simd_f32x32_cmpne_instruction_set
//#endif
//#ifdef _simd_f32x32_cmpne_scalar_
//	#define _simd_f32x32_cmpne_scalar(X,Y) _simd_f32x32_cmpne_scalar_(X,Y)
//	#define _simd_f32x32_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f32x32_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_f32x32_cmpne_scalar(X,Y) _simd_f32x32_cmpne_safe(X,_simd_f32x32_fill_scalar_safe(Y))
//	#define _simd_f32x32_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_f32x1_cmpne_safe
//	#define _simd_f32x1_cmpne_safe(X,Y) static_cast<_simd_f32x1>(X != Y)
...
//#else
//	#define _simd_f32x64_cmpne(X,Y) _simd_f32x64_combine(\
...
//
//
//#if defined(_simd_f32x64_cmpne_) && ! defined(_simd_f32x64_cmpne_scalar_)
//	#define _simd_f32x64_cmpne_scalar_(X,Y) _simd_f32x64_cmpne_(X,_simd_f32x64_fill_scalar_(Y))
//	#define _simd_f32x64_cmpne_scalar_instruction_set _simd_f32x64_cmpne_instruction_set
//#endif
//#ifdef _simd_f32x64_cmpne_scalar_
//	#define _simd_f32x64_cmpne_scalar(X,Y) _simd_f32x64_cmpne_scalar_(X,Y)
//	#define _simd_f32x64_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_f32x64_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_f32x64_cmpne_scalar(X,Y) _simd_f32x64_cmpne_safe(X,_simd_f32x64_fill_scalar_safe(Y))
//	#define _simd_f32x64_cmpne_scalar_enabled() true
//#endif
//
//// -- s64 --
//
...
//#else
//	#define _simd_s64x2_cmpne(X,Y) _simd_s64x2_combine(\
...
//
//
//#if defined(_simd_s64x2_cmpne_) && ! defined(_simd_s64x2_cmpne_scalar_)
//	#define _simd_s64x2_cmpne_scalar_(X,Y) _simd_s64x2_cmpne_(X,_simd_s64x2_fill_scalar_(Y))
//	#define _simd_s64x2_cmpne_scalar_instruction_set _simd_s64x2_cmpne_instruction_set
//#endif
//#ifdef _simd_s64x2_cmpne_scalar_
//	#define _simd_s64x2_cmpne_scalar(X,Y) _simd_s64x2_cmpne_scalar_(X,Y)
//	#define _simd_s64x2_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s64x2_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s64x2_cmpne_scalar(X,Y) _simd_s64x2_cmpne_safe(X,_simd_s64x2_fill_scalar_safe(Y))
//	#define _simd_s64x2_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_s64x1_cmpne_safe
//	#define _simd_s64x1_cmpne_safe(X,Y) static_cast<_simd_s64x1>(X != Y)
...
//#else
//	#define _simd_s64x4_cmpne(X,Y) _simd_s64x4_combine(\
...
//
//
//#if defined(_simd_s64x4_cmpne_) && ! defined(_simd_s64x4_cmpne_scalar_)
//	#define _simd_s64x4_cmpne_scalar_(X,Y) _simd_s64x4_cmpne_(X,_simd_s64x4_fill_scalar_(Y))
//	#define _simd_s64x4_cmpne_scalar_instruction_set _simd_s64x4_cmpne_instruction_set
//#endif
//#ifdef _simd_s64x4_cmpne_scalar_
//	#define _simd_s64x4_cmpne_scalar(X,Y) _simd_s64x4_cmpne_scalar_(X,Y)
//	#define _simd_s64x4_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s64x4_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s64x4_cmpne_scalar(X,Y) _simd_s64x4_cmpne_safe(X,_simd_s64x4_fill_scalar_safe(Y))
//	#define _simd_s64x4_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_s64x1_cmpne_safe
//	#define _simd_s64x1_cmpne_safe(X,Y) static_cast<_simd_s64x1>(X != Y)
...
//#else
//	#define _simd_s64x8_cmpne(X,Y) _simd_s64x8_combine(\
...
//
//
//#if defined(_simd_s64x8_cmpne_) && ! defined(_simd_s64x8_cmpne_scalar_)
//	#define _simd_s64x8_cmpne_scalar_(X,Y) _simd_s64x8_cmpne_(X,_simd_s64x8_fill_scalar_(Y))
//	#define _simd_s64x8_cmpne_scalar_instruction_set _simd_s64x8_cmpne_instruction_set
//#endif
//#ifdef _simd_s64x8_cmpne_scalar_
//	#define _simd_s64x8_cmpne_scalar(X,Y) _simd_s64x8_cmpne_scalar_(X,Y)
//	#define _simd_s64x8_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s64x8_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s64x8_cmpne_scalar(X,Y) _simd_s64x8_cmpne_safe(X,_simd_s64x8_fill_scalar_safe(Y))
//	#define _simd_s64x8_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_s64x1_cmpne_safe
//	#define _simd_s64x1_cmpne_safe(X,Y) static_cast<_simd_s64x1>(X != Y)
...
//#else
//	#define _simd_s64x16_cmpne(X,Y) _simd_s64x16_combine(\
...
//
//
//#if defined(_simd_s64x16_cmpne_) && ! defined(_simd_s64x16_cmpne_scalar_)
//	#define _simd_s64x16_cmpne_scalar_(X,Y) _simd_s64x16_cmpne_(X,_simd_s64x16_fill_scalar_(Y))
//	#define _simd_s64x16_cmpne_scalar_instruction_set _simd_s64x16_cmpne_instruction_set
//#endif
//#ifdef _simd_s64x16_cmpne_scalar_
//	#define _simd_s64x16_cmpne_scalar(X,Y) _simd_s64x16_cmpne_scalar_(X,Y)
//	#define _simd_s64x16_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s64x16_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s64x16_cmpne_scalar(X,Y) _simd_s64x16_cmpne_safe(X,_simd_s64x16_fill_scalar_safe(Y))
//	#define _simd_s64x16_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_s64x1_cmpne_safe
//	#define _simd_s64x1_cmpne_safe(X,Y) static_cast<_simd_s64x1>(X != Y)
...
//#else
//	#define _simd_s64x32_cmpne(X,Y) _simd_s64x32_combine(\
...
//
//
//#if defined(_simd_s64x32_cmpne_) && ! defined(_simd_s64x32_cmpne_scalar_)
//	#define _simd_s64x32_cmpne_scalar_(X,Y) _simd_s64x32_cmpne_(X,_simd_s64x32_fill_scalar_(Y))
//	#define _simd_s64x32_cmpne_scalar_instruction_set _simd_s64x32_cmpne_instruction_set
//#endif
//#ifdef _simd_s64x32_cmpne_scalar_
//	#define _simd_s64x32_cmpne_scalar(X,Y) _simd_s64x32_cmpne_scalar_(X,Y)
//	#define _simd_s64x32_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s64x32_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s64x32_cmpne_scalar(X,Y) _simd_s64x32_cmpne_safe(X,_simd_s64x32_fill_scalar_safe(Y))
//	#define _simd_s64x32_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_s64x1_cmpne_safe
//	#define _simd_s64x1_cmpne_safe(X,Y) static_cast<_simd_s64x1>(X != Y)
...
//#else
//	#define _simd_s64x64_cmpne(X,Y) _simd_s64x64_combine(\
...
//
//
//#if defined(_simd_s64x64_cmpne_) && ! defined(_simd_s64x64_cmpne_scalar_)
//	#define _simd_s64x64_cmpne_scalar_(X,Y) _simd_s64x64_cmpne_(X,_simd_s64x64_fill_scalar_(Y))
//	#define _simd_s64x64_cmpne_scalar_instruction_set _simd_s64x64_cmpne_instruction_set
//#endif
//#ifdef _simd_s64x64_cmpne_scalar_
//	#define _simd_s64x64_cmpne_scalar(X,Y) _simd_s64x64_cmpne_scalar_(X,Y)
//	#define _simd_s64x64_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s64x64_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s64x64_cmpne_scalar(X,Y) _simd_s64x64_cmpne_safe(X,_simd_s64x64_fill_scalar_safe(Y))
//	#define _simd_s64x64_cmpne_scalar_enabled() true
//#endif
//
//// -- u64 --
//
...
//#else
//	#define _simd_u64x2_cmpne(X,Y) _simd_u64x2_combine(\
...
//
//
//#if defined(_simd_u64x2_cmpne_) && ! defined(_simd_u64x2_cmpne_scalar_)
//	#define _simd_u64x2_cmpne_scalar_(X,Y) _simd_u64x2_cmpne_(X,_simd_u64x2_fill_scalar_(Y))
//	#define _simd_u64x2_cmpne_scalar_instruction_set _simd_u64x2_cmpne_instruction_set
//#endif
//#ifdef _simd_u64x2_cmpne_scalar_
//	#define _simd_u64x2_cmpne_scalar(X,Y) _simd_u64x2_cmpne_scalar_(X,Y)
//	#define _simd_u64x2_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u64x2_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u64x2_cmpne_scalar(X,Y) _simd_u64x2_cmpne_safe(X,_simd_u64x2_fill_scalar_safe(Y))
//	#define _simd_u64x2_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_u64x1_cmpne_safe
//	#define _simd_u64x1_cmpne_safe(X,Y) static_cast<_simd_u64x1>(X != Y)
...
//#else
//	#define _simd_u64x4_cmpne(X,Y) _simd_u64x4_combine(\
...
//
//
//#if defined(_simd_u64x4_cmpne_) && ! defined(_simd_u64x4_cmpne_scalar_)
//	#define _simd_u64x4_cmpne_scalar_(X,Y) _simd_u64x4_cmpne_(X,_simd_u64x4_fill_scalar_(Y))
//	#define _simd_u64x4_cmpne_scalar_instruction_set _simd_u64x4_cmpne_instruction_set
//#endif
//#ifdef _simd_u64x4_cmpne_scalar_
//	#define _simd_u64x4_cmpne_scalar(X,Y) _simd_u64x4_cmpne_scalar_(X,Y)
//	#define _simd_u64x4_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u64x4_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u64x4_cmpne_scalar(X,Y) _simd_u64x4_cmpne_safe(X,_simd_u64x4_fill_scalar_safe(Y))
//	#define _simd_u64x4_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_u64x1_cmpne_safe
//	#define _simd_u64x1_cmpne_safe(X,Y) static_cast<_simd_u64x1>(X != Y)
...
//#else
//	#define _simd_u64x8_cmpne(X,Y) _simd_u64x8_combine(\
...
//
//
//#if defined(_simd_u64x8_cmpne_) && ! defined(_simd_u64x8_cmpne_scalar_)
//	#define _simd_u64x8_cmpne_scalar_(X,Y) _simd_u64x8_cmpne_(X,_simd_u64x8_fill_scalar_(Y))
//	#define _simd_u64x8_cmpne_scalar_instruction_set _simd_u64x8_cmpne_instruction_set
//#endif
//#ifdef _simd_u64x8_cmpne_scalar_
//	#define _simd_u64x8_cmpne_scalar(X,Y) _simd_u64x8_cmpne_scalar_(X,Y)
//	#define _simd_u64x8_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u64x8_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u64x8_cmpne_scalar(X,Y) _simd_u64x8_cmpne_safe(X,_simd_u64x8_fill_scalar_safe(Y))
//	#define _simd_u64x8_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_u64x1_cmpne_safe
//	#define _simd_u64x1_cmpne_safe(X,Y) static_cast<_simd_u64x1>(X != Y)
...
//#else
//	#define _simd_u64x16_cmpne(X,Y) _simd_u64x16_combine(\
...
//
//
//#if defined(_simd_u64x16_cmpne_) && ! defined(_simd_u64x16_cmpne_scalar_)
//	#define _simd_u64x16_cmpne_scalar_(X,Y) _simd_u64x16_cmpne_(X,_simd_u64x16_fill_scalar_(Y))
//	#define _simd_u64x16_cmpne_scalar_instruction_set _simd_u64x16_cmpne_instruction_set
//#endif
//#ifdef _simd_u64x16_cmpne_scalar_
//	#define _simd_u64x16_cmpne_scalar(X,Y) _simd_u64x16_cmpne_scalar_(X,Y)
//	#define _simd_u64x16_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u64x16_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u64x16_cmpne_scalar(X,Y) _simd_u64x16_cmpne_safe(X,_simd_u64x16_fill_scalar_safe(Y))
//	#define _simd_u64x16_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_u64x1_cmpne_safe
//	#define _simd_u64x1_cmpne_safe(X,Y) static_cast<_simd_u64x1>(X != Y)
...
//#else
//	#define _simd_u64x32_cmpne(X,Y) _simd_u64x32_combine(\
...
//
//
//#if defined(_simd_u64x32_cmpne_) && ! defined(_simd_u64x32_cmpne_scalar_)
//	#define _simd_u64x32_cmpne_scalar_(X,Y) _simd_u64x32_cmpne_(X,_simd_u64x32_fill_scalar_(Y))
//	#define _simd_u64x32_cmpne_scalar_instruction_set _simd_u64x32_cmpne_instruction_set
//#endif
//#ifdef _simd_u64x32_cmpne_scalar_
//	#define _simd_u64x32_cmpne_scalar(X,Y) _simd_u64x32_cmpne_scalar_(X,Y)
//	#define _simd_u64x32_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u64x32_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u64x32_cmpne_scalar(X,Y) _simd_u64x32_cmpne_safe(X,_simd_u64x32_fill_scalar_safe(Y))
//	#define _simd_u64x32_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_u64x1_cmpne_safe
//	#define _simd_u64x1_cmpne_safe(X,Y) static_cast<_simd_u64x1>(X != Y)
...
//#else
//	#define _simd_u64x64_cmpne(X,Y) _simd_u64x64_combine(\
...
//
//
//#if defined(_simd_u64x64_cmpne_) && ! defined(_simd_u64x64_cmpne_scalar_)
//	#define _simd_u64x64_cmpne_scalar_(X,Y) _simd_u64x64_cmpne_(X,_simd_u64x64_fill_scalar_(Y))
//	#define _simd_u64x64_cmpne_scalar_instruction_set _simd_u64x64_cmpne_instruction_set
//#endif
//#ifdef _simd_u64x64_cmpne_scalar_
//	#define _simd_u64x64_cmpne_scalar(X,Y) _simd_u64x64_cmpne_scalar_(X,Y)
//	#define _simd_u64x64_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u64x64_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u64x64_cmpne_scalar(X,Y) _simd_u64x64_cmpne_safe(X,_simd_u64x64_fill_scalar_safe(Y))
//	#define _simd_u64x64_cmpne_scalar_enabled() true
//#endif
//
//// -- s32 --
//
...
//#else
//	#define _simd_s32x2_cmpne(X,Y) _simd_s32x2_combine(\
...
//
//
//#if defined(_simd_s32x2_cmpne_) && ! defined(_simd_s32x2_cmpne_scalar_)
//	#define _simd_s32x2_cmpne_scalar_(X,Y) _simd_s32x2_cmpne_(X,_simd_s32x2_fill_scalar_(Y))
//	#define _simd_s32x2_cmpne_scalar_instruction_set _simd_s32x2_cmpne_instruction_set
//#endif
//#ifdef _simd_s32x2_cmpne_scalar_
//	#define _simd_s32x2_cmpne_scalar(X,Y) _simd_s32x2_cmpne_scalar_(X,Y)
//	#define _simd_s32x2_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s32x2_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s32x2_cmpne_scalar(X,Y) _simd_s32x2_cmpne_safe(X,_simd_s32x2_fill_scalar_safe(Y))
//	#define _simd_s32x2_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_s32x1_cmpne_safe
//	#define _simd_s32x1_cmpne_safe(X,Y) static_cast<_simd_s32x1>(X != Y)
...
//#else
//	#define _simd_s32x4_cmpne(X,Y) _simd_s32x4_combine(\
...
//
//
//#if defined(_simd_s32x4_cmpne_) && ! defined(_simd_s32x4_cmpne_scalar_)
//	#define _simd_s32x4_cmpne_scalar_(X,Y) _simd_s32x4_cmpne_(X,_simd_s32x4_fill_scalar_(Y))
//	#define _simd_s32x4_cmpne_scalar_instruction_set _simd_s32x4_cmpne_instruction_set
//#endif
//#ifdef _simd_s32x4_cmpne_scalar_
//	#define _simd_s32x4_cmpne_scalar(X,Y) _simd_s32x4_cmpne_scalar_(X,Y)
//	#define _simd_s32x4_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s32x4_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s32x4_cmpne_scalar(X,Y) _simd_s32x4_cmpne_safe(X,_simd_s32x4_fill_scalar_safe(Y))
//	#define _simd_s32x4_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_s32x1_cmpne_safe
//	#define _simd_s32x1_cmpne_safe(X,Y) static_cast<_simd_s32x1>(X != Y)
...
//#else
//	#define _simd_s32x8_cmpne(X,Y) _simd_s32x8_combine(\
...
//
//
//#if defined(_simd_s32x8_cmpne_) && ! defined(_simd_s32x8_cmpne_scalar_)
//	#define _simd_s32x8_cmpne_scalar_(X,Y) _simd_s32x8_cmpne_(X,_simd_s32x8_fill_scalar_(Y))
//	#define _simd_s32x8_cmpne_scalar_instruction_set _simd_s32x8_cmpne_instruction_set
//#endif
//#ifdef _simd_s32x8_cmpne_scalar_
//	#define _simd_s32x8_cmpne_scalar(X,Y) _simd_s32x8_cmpne_scalar_(X,Y)
//	#define _simd_s32x8_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s32x8_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s32x8_cmpne_scalar(X,Y) _simd_s32x8_cmpne_safe(X,_simd_s32x8_fill_scalar_safe(Y))
//	#define _simd_s32x8_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_s32x1_cmpne_safe
//	#define _simd_s32x1_cmpne_safe(X,Y) static_cast<_simd_s32x1>(X != Y)
...
//#else
//	#define _simd_s32x16_cmpne(X,Y) _simd_s32x16_combine(\
...
//
//
//#if defined(_simd_s32x16_cmpne_) && ! defined(_simd_s32x16_cmpne_scalar_)
//	#define _simd_s32x16_cmpne_scalar_(X,Y) _simd_s32x16_cmpne_(X,_simd_s32x16_fill_scalar_(Y))
//	#define _simd_s32x16_cmpne_scalar_instruction_set _simd_s32x16_cmpne_instruction_set
//#endif
//#ifdef _simd_s32x16_cmpne_scalar_
//	#define _simd_s32x16_cmpne_scalar(X,Y) _simd_s32x16_cmpne_scalar_(X,Y)
//	#define _simd_s32x16_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s32x16_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s32x16_cmpne_scalar(X,Y) _simd_s32x16_cmpne_safe(X,_simd_s32x16_fill_scalar_safe(Y))
//	#define _simd_s32x16_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_s32x1_cmpne_safe
//	#define _simd_s32x1_cmpne_safe(X,Y) static_cast<_simd_s32x1>(X != Y)
...
//#else
//	#define _simd_s32x32_cmpne(X,Y) _simd_s32x32_combine(\
...
//
//
//#if defined(_simd_s32x32_cmpne_) && ! defined(_simd_s32x32_cmpne_scalar_)
//	#define _simd_s32x32_cmpne_scalar_(X,Y) _simd_s32x32_cmpne_(X,_simd_s32x32_fill_scalar_(Y))
//	#define _simd_s32x32_cmpne_scalar_instruction_set _simd_s32x32_cmpne_instruction_set
//#endif
//#ifdef _simd_s32x32_cmpne_scalar_
//	#define _simd_s32x32_cmpne_scalar(X,Y) _simd_s32x32_cmpne_scalar_(X,Y)
//	#define _simd_s32x32_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s32x32_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s32x32_cmpne_scalar(X,Y) _simd_s32x32_cmpne_safe(X,_simd_s32x32_fill_scalar_safe(Y))
//	#define _simd_s32x32_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_s32x1_cmpne_safe
//	#define _simd_s32x1_cmpne_safe(X,Y) static_cast<_simd_s32x1>(X != Y)
...
//#else
//	#define _simd_s32x64_cmpne(X,Y) _simd_s32x64_combine(\
...
//
//
//#if defined(_simd_s32x64_cmpne_) && ! defined(_simd_s32x64_cmpne_scalar_)
//	#define _simd_s32x64_cmpne_scalar_(X,Y) _simd_s32x64_cmpne_(X,_simd_s32x64_fill_scalar_(Y))
//	#define _simd_s32x64_cmpne_scalar_instruction_set _simd_s32x64_cmpne_instruction_set
//#endif
//#ifdef _simd_s32x64_cmpne_scalar_
//	#define _simd_s32x64_cmpne_scalar(X,Y) _simd_s32x64_cmpne_scalar_(X,Y)
//	#define _simd_s32x64_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s32x64_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s32x64_cmpne_scalar(X,Y) _simd_s32x64_cmpne_safe(X,_simd_s32x64_fill_scalar_safe(Y))
//	#define _simd_s32x64_cmpne_scalar_enabled() true
//#endif
//
//// -- u32 --
//
...
//#else
//	#define _simd_u32x2_cmpne(X,Y) _simd_u32x2_combine(\
...
//
//
//#if defined(_simd_u32x2_cmpne_) && ! defined(_simd_u32x2_cmpne_scalar_)
//	#define _simd_u32x2_cmpne_scalar_(X,Y) _simd_u32x2_cmpne_(X,_simd_u32x2_fill_scalar_(Y))
//	#define _simd_u32x2_cmpne_scalar_instruction_set _simd_u32x2_cmpne_instruction_set
//#endif
//#ifdef _simd_u32x2_cmpne_scalar_
//	#define _simd_u32x2_cmpne_scalar(X,Y) _simd_u32x2_cmpne_scalar_(X,Y)
//	#define _simd_u32x2_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u32x2_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u32x2_cmpne_scalar(X,Y) _simd_u32x2_cmpne_safe(X,_simd_u32x2_fill_scalar_safe(Y))
//	#define _simd_u32x2_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_u32x1_cmpne_safe
//	#define _simd_u32x1_cmpne_safe(X,Y) static_cast<_simd_u32x1>(X != Y)
...
//#else
//	#define _simd_u32x4_cmpne(X,Y) _simd_u32x4_combine(\
...
//
//
//#if defined(_simd_u32x4_cmpne_) && ! defined(_simd_u32x4_cmpne_scalar_)
//	#define _simd_u32x4_cmpne_scalar_(X,Y) _simd_u32x4_cmpne_(X,_simd_u32x4_fill_scalar_(Y))
//	#define _simd_u32x4_cmpne_scalar_instruction_set _simd_u32x4_cmpne_instruction_set
//#endif
//#ifdef _simd_u32x4_cmpne_scalar_
//	#define _simd_u32x4_cmpne_scalar(X,Y) _simd_u32x4_cmpne_scalar_(X,Y)
//	#define _simd_u32x4_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u32x4_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u32x4_cmpne_scalar(X,Y) _simd_u32x4_cmpne_safe(X,_simd_u32x4_fill_scalar_safe(Y))
//	#define _simd_u32x4_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_u32x1_cmpne_safe
//	#define _simd_u32x1_cmpne_safe(X,Y) static_cast<_simd_u32x1>(X != Y)
...
//#else
//	#define _simd_u32x8_cmpne(X,Y) _simd_u32x8_combine(\
...
//
//
//#if defined(_simd_u32x8_cmpne_) && ! defined(_simd_u32x8_cmpne_scalar_)
//	#define _simd_u32x8_cmpne_scalar_(X,Y) _simd_u32x8_cmpne_(X,_simd_u32x8_fill_scalar_(Y))
//	#define _simd_u32x8_cmpne_scalar_instruction_set _simd_u32x8_cmpne_instruction_set
//#endif
//#ifdef _simd_u32x8_cmpne_scalar_
//	#define _simd_u32x8_cmpne_scalar(X,Y) _simd_u32x8_cmpne_scalar_(X,Y)
//	#define _simd_u32x8_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u32x8_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u32x8_cmpne_scalar(X,Y) _simd_u32x8_cmpne_safe(X,_simd_u32x8_fill_scalar_safe(Y))
//	#define _simd_u32x8_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_u32x1_cmpne_safe
//	#define _simd_u32x1_cmpne_safe(X,Y) static_cast<_simd_u32x1>(X != Y)
...
//#else
//	#define _simd_u32x16_cmpne(X,Y) _simd_u32x16_combine(\
...
//
//
//#if defined(_simd_u32x16_cmpne_) && ! defined(_simd_u32x16_cmpne_scalar_)
//	#define _simd_u32x16_cmpne_scalar_(X,Y) _simd_u32x16_cmpne_(X,_simd_u32x16_fill_scalar_(Y))
//	#define _simd_u32x16_cmpne_scalar_instruction_set _simd_u32x16_cmpne_instruction_set
//#endif
//#ifdef _simd_u32x16_cmpne_scalar_
//	#define _simd_u32x16_cmpne_scalar(X,Y) _simd_u32x16_cmpne_scalar_(X,Y)
//	#define _simd_u32x16_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u32x16_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u32x16_cmpne_scalar(X,Y) _simd_u32x16_cmpne_safe(X,_simd_u32x16_fill_scalar_safe(Y))
//	#define _simd_u32x16_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_u32x1_cmpne_safe
//	#define _simd_u32x1_cmpne_safe(X,Y) static_cast<_simd_u32x1>(X != Y)
...
//#else
//	#define _simd_u32x32_cmpne(X,Y) _simd_u32x32_combine(\
...
//
//
//#if defined(_simd_u32x32_cmpne_) && ! defined(_simd_u32x32_cmpne_scalar_)
//	#define _simd_u32x32_cmpne_scalar_(X,Y) _simd_u32x32_cmpne_(X,_simd_u32x32_fill_scalar_(Y))
//	#define _simd_u32x32_cmpne_scalar_instruction_set _simd_u32x32_cmpne_instruction_set
//#endif
//#ifdef _simd_u32x32_cmpne_scalar_
//	#define _simd_u32x32_cmpne_scalar(X,Y) _simd_u32x32_cmpne_scalar_(X,Y)
//	#define _simd_u32x32_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u32x32_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u32x32_cmpne_scalar(X,Y) _simd_u32x32_cmpne_safe(X,_simd_u32x32_fill_scalar_safe(Y))
//	#define _simd_u32x32_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_u32x1_cmpne_safe
//	#define _simd_u32x1_cmpne_safe(X,Y) static_cast<_simd_u32x1>(X != Y)
...
//#else
//	#define _simd_u32x64_cmpne(X,Y) _simd_u32x64_combine(\
...
//
//
//#if defined(_simd_u32x64_cmpne_) && ! defined(_simd_u32x64_cmpne_scalar_)
//	#define _simd_u32x64_cmpne_scalar_(X,Y) _simd_u32x64_cmpne_(X,_simd_u32x64_fill_scalar_(Y))
//	#define _simd_u32x64_cmpne_scalar_instruction_set _simd_u32x64_cmpne_instruction_set
//#endif
//#ifdef _simd_u32x64_cmpne_scalar_
//	#define _simd_u32x64_cmpne_scalar(X,Y) _simd_u32x64_cmpne_scalar_(X,Y)
//	#define _simd_u32x64_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u32x64_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u32x64_cmpne_scalar(X,Y) _simd_u32x64_cmpne_safe(X,_simd_u32x64_fill_scalar_safe(Y))
//	#define _simd_u32x64_cmpne_scalar_enabled() true
//#endif
//
//// -- s16 --
//
...
//#else
//	#define _simd_s16x2_cmpne(X,Y) _simd_s16x2_combine(\
...
//
//
//#if defined(_simd_s16x2_cmpne_) && ! defined(_simd_s16x2_cmpne_scalar_)
//	#define _simd_s16x2_cmpne_scalar_(X,Y) _simd_s16x2_cmpne_(X,_simd_s16x2_fill_scalar_(Y))
//	#define _simd_s16x2_cmpne_scalar_instruction_set _simd_s16x2_cmpne_instruction_set
//#endif
//#ifdef _simd_s16x2_cmpne_scalar_
//	#define _simd_s16x2_cmpne_scalar(X,Y) _simd_s16x2_cmpne_scalar_(X,Y)
//	#define _simd_s16x2_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s16x2_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s16x2_cmpne_scalar(X,Y) _simd_s16x2_cmpne_safe(X,_simd_s16x2_fill_scalar_safe(Y))
//	#define _simd_s16x2_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_s16x1_cmpne_safe
//	#define _simd_s16x1_cmpne_safe(X,Y) static_cast<_simd_s16x1>(X != Y)
...
//#else
//	#define _simd_s16x4_cmpne(X,Y) _simd_s16x4_combine(\
...
//
//
//#if defined(_simd_s16x4_cmpne_) && ! defined(_simd_s16x4_cmpne_scalar_)
//	#define _simd_s16x4_cmpne_scalar_(X,Y) _simd_s16x4_cmpne_(X,_simd_s16x4_fill_scalar_(Y))
//	#define _simd_s16x4_cmpne_scalar_instruction_set _simd_s16x4_cmpne_instruction_set
//#endif
//#ifdef _simd_s16x4_cmpne_scalar_
//	#define _simd_s16x4_cmpne_scalar(X,Y) _simd_s16x4_cmpne_scalar_(X,Y)
//	#define _simd_s16x4_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s16x4_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s16x4_cmpne_scalar(X,Y) _simd_s16x4_cmpne_safe(X,_simd_s16x4_fill_scalar_safe(Y))
//	#define _simd_s16x4_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_s16x1_cmpne_safe
//	#define _simd_s16x1_cmpne_safe(X,Y) static_cast<_simd_s16x1>(X != Y)
...
//#else
//	#define _simd_s16x8_cmpne(X,Y) _simd_s16x8_combine(\
...
//
//
//#if defined(_simd_s16x8_cmpne_) && ! defined(_simd_s16x8_cmpne_scalar_)
//	#define _simd_s16x8_cmpne_scalar_(X,Y) _simd_s16x8_cmpne_(X,_simd_s16x8_fill_scalar_(Y))
//	#define _simd_s16x8_cmpne_scalar_instruction_set _simd_s16x8_cmpne_instruction_set
//#endif
//#ifdef _simd_s16x8_cmpne_scalar_
//	#define _simd_s16x8_cmpne_scalar(X,Y) _simd_s16x8_cmpne_scalar_(X,Y)
//	#define _simd_s16x8_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s16x8_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s16x8_cmpne_scalar(X,Y) _simd_s16x8_cmpne_safe(X,_simd_s16x8_fill_scalar_safe(Y))
//	#define _simd_s16x8_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_s16x1_cmpne_safe
//	#define _simd_s16x1_cmpne_safe(X,Y) static_cast<_simd_s16x1>(X != Y)
...
//#else
//	#define _simd_s16x16_cmpne(X,Y) _simd_s16x16_combine(\
...
//
//
//#if defined(_simd_s16x16_cmpne_) && ! defined(_simd_s16x16_cmpne_scalar_)
//	#define _simd_s16x16_cmpne_scalar_(X,Y) _simd_s16x16_cmpne_(X,_simd_s16x16_fill_scalar_(Y))
//	#define _simd_s16x16_cmpne_scalar_instruction_set _simd_s16x16_cmpne_instruction_set
//#endif
//#ifdef _simd_s16x16_cmpne_scalar_
//	#define _simd_s16x16_cmpne_scalar(X,Y) _simd_s16x16_cmpne_scalar_(X,Y)
//	#define _simd_s16x16_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s16x16_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s16x16_cmpne_scalar(X,Y) _simd_s16x16_cmpne_safe(X,_simd_s16x16_fill_scalar_safe(Y))
//	#define _simd_s16x16_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_s16x1_cmpne_safe
//	#define _simd_s16x1_cmpne_safe(X,Y) static_cast<_simd_s16x1>(X != Y)
...
//#else
//	#define _simd_s16x32_cmpne(X,Y) _simd_s16x32_combine(\
...
//
//
//#if defined(_simd_s16x32_cmpne_) && ! defined(_simd_s16x32_cmpne_scalar_)
//	#define _simd_s16x32_cmpne_scalar_(X,Y) _simd_s16x32_cmpne_(X,_simd_s16x32_fill_scalar_(Y))
//	#define _simd_s16x32_cmpne_scalar_instruction_set _simd_s16x32_cmpne_instruction_set
//#endif
//#ifdef _simd_s16x32_cmpne_scalar_
//	#define _simd_s16x32_cmpne_scalar(X,Y) _simd_s16x32_cmpne_scalar_(X,Y)
//	#define _simd_s16x32_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s16x32_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s16x32_cmpne_scalar(X,Y) _simd_s16x32_cmpne_safe(X,_simd_s16x32_fill_scalar_safe(Y))
//	#define _simd_s16x32_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_s16x1_cmpne_safe
//	#define _simd_s16x1_cmpne_safe(X,Y) static_cast<_simd_s16x1>(X != Y)
...
//#else
//	#define _simd_s16x64_cmpne(X,Y) _simd_s16x64_combine(\
...
//
//
//#if defined(_simd_s16x64_cmpne_) && ! defined(_simd_s16x64_cmpne_scalar_)
//	#define _simd_s16x64_cmpne_scalar_(X,Y) _simd_s16x64_cmpne_(X,_simd_s16x64_fill_scalar_(Y))
//	#define _simd_s16x64_cmpne_scalar_instruction_set _simd_s16x64_cmpne_instruction_set
//#endif
//#ifdef _simd_s16x64_cmpne_scalar_
//	#define _simd_s16x64_cmpne_scalar(X,Y) _simd_s16x64_cmpne_scalar_(X,Y)
//	#define _simd_s16x64_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s16x64_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s16x64_cmpne_scalar(X,Y) _simd_s16x64_cmpne_safe(X,_simd_s16x64_fill_scalar_safe(Y))
//	#define _simd_s16x64_cmpne_scalar_enabled() true
//#endif
//
//// -- u16 --
//
...
//#else
//	#define _simd_u16x2_cmpne(X,Y) _simd_u16x2_combine(\
...
//
//
//#if defined(_simd_u16x2_cmpne_) && ! defined(_simd_u16x2_cmpne_scalar_)
//	#define _simd_u16x2_cmpne_scalar_(X,Y) _simd_u16x2_cmpne_(X,_simd_u16x2_fill_scalar_(Y))
//	#define _simd_u16x2_cmpne_scalar_instruction_set _simd_u16x2_cmpne_instruction_set
//#endif
//#ifdef _simd_u16x2_cmpne_scalar_
//	#define _simd_u16x2_cmpne_scalar(X,Y) _simd_u16x2_cmpne_scalar_(X,Y)
//	#define _simd_u16x2_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u16x2_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u16x2_cmpne_scalar(X,Y) _simd_u16x2_cmpne_safe(X,_simd_u16x2_fill_scalar_safe(Y))
//	#define _simd_u16x2_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_u16x1_cmpne_safe
//	#define _simd_u16x1_cmpne_safe(X,Y) static_cast<_simd_u16x1>(X != Y)
...
//#else
//	#define _simd_u16x4_cmpne(X,Y) _simd_u16x4_combine(\
...
//
//
//#if defined(_simd_u16x4_cmpne_) && ! defined(_simd_u16x4_cmpne_scalar_)
//	#define _simd_u16x4_cmpne_scalar_(X,Y) _simd_u16x4_cmpne_(X,_simd_u16x4_fill_scalar_(Y))
//	#define _simd_u16x4_cmpne_scalar_instruction_set _simd_u16x4_cmpne_instruction_set
//#endif
//#ifdef _simd_u16x4_cmpne_scalar_
//	#define _simd_u16x4_cmpne_scalar(X,Y) _simd_u16x4_cmpne_scalar_(X,Y)
//	#define _simd_u16x4_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u16x4_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u16x4_cmpne_scalar(X,Y) _simd_u16x4_cmpne_safe(X,_simd_u16x4_fill_scalar_safe(Y))
//	#define _simd_u16x4_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_u16x1_cmpne_safe
//	#define _simd_u16x1_cmpne_safe(X,Y) static_cast<_simd_u16x1>(X != Y)
...
//#else
//	#define _simd_u16x8_cmpne(X,Y) _simd_u16x8_combine(\
...
//
//
//#if defined(_simd_u16x8_cmpne_) && ! defined(_simd_u16x8_cmpne_scalar_)
//	#define _simd_u16x8_cmpne_scalar_(X,Y) _simd_u16x8_cmpne_(X,_simd_u16x8_fill_scalar_(Y))
//	#define _simd_u16x8_cmpne_scalar_instruction_set _simd_u16x8_cmpne_instruction_set
//#endif
//#ifdef _simd_u16x8_cmpne_scalar_
//	#define _simd_u16x8_cmpne_scalar(X,Y) _simd_u16x8_cmpne_scalar_(X,Y)
//	#define _simd_u16x8_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u16x8_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u16x8_cmpne_scalar(X,Y) _simd_u16x8_cmpne_safe(X,_simd_u16x8_fill_scalar_safe(Y))
//	#define _simd_u16x8_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_u16x1_cmpne_safe
//	#define _simd_u16x1_cmpne_safe(X,Y) static_cast<_simd_u16x1>(X != Y)
...
//#else
//	#define _simd_u16x16_cmpne(X,Y) _simd_u16x16_combine(\
...
//
//
//#if defined(_simd_u16x16_cmpne_) && ! defined(_simd_u16x16_cmpne_scalar_)
//	#define _simd_u16x16_cmpne_scalar_(X,Y) _simd_u16x16_cmpne_(X,_simd_u16x16_fill_scalar_(Y))
//	#define _simd_u16x16_cmpne_scalar_instruction_set _simd_u16x16_cmpne_instruction_set
//#endif
//#ifdef _simd_u16x16_cmpne_scalar_
//	#define _simd_u16x16_cmpne_scalar(X,Y) _simd_u16x16_cmpne_scalar_(X,Y)
//	#define _simd_u16x16_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u16x16_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u16x16_cmpne_scalar(X,Y) _simd_u16x16_cmpne_safe(X,_simd_u16x16_fill_scalar_safe(Y))
//	#define _simd_u16x16_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_u16x1_cmpne_safe
//	#define _simd_u16x1_cmpne_safe(X,Y) static_cast<_simd_u16x1>(X != Y)
...
//#else
//	#define _simd_u16x32_cmpne(X,Y) _simd_u16x32_combine(\
...
//
//
//#if defined(_simd_u16x32_cmpne_) && ! defined(_simd_u16x32_cmpne_scalar_)
//	#define _simd_u16x32_cmpne_scalar_(X,Y) _simd_u16x32_cmpne_(X,_simd_u16x32_fill_scalar_(Y))
//	#define _simd_u16x32_cmpne_scalar_instruction_set _simd_u16x32_cmpne_instruction_set
//#endif
//#ifdef _simd_u16x32_cmpne_scalar_
//	#define _simd_u16x32_cmpne_scalar(X,Y) _simd_u16x32_cmpne_scalar_(X,Y)
//	#define _simd_u16x32_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u16x32_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u16x32_cmpne_scalar(X,Y) _simd_u16x32_cmpne_safe(X,_simd_u16x32_fill_scalar_safe(Y))
//	#define _simd_u16x32_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_u16x1_cmpne_safe
//	#define _simd_u16x1_cmpne_safe(X,Y) static_cast<_simd_u16x1>(X != Y)
...
//#else
//	#define _simd_u16x64_cmpne(X,Y) _simd_u16x64_combine(\
...
//
//
//#if defined(_simd_u16x64_cmpne_) && ! defined(_simd_u16x64_cmpne_scalar_)
//	#define _simd_u16x64_cmpne_scalar_(X,Y) _simd_u16x64_cmpne_(X,_simd_u16x64_fill_scalar_(Y))
//	#define _simd_u16x64_cmpne_scalar_instruction_set _simd_u16x64_cmpne_instruction_set
//#endif
//#ifdef _simd_u16x64_cmpne_scalar_
//	#define _simd_u16x64_cmpne_scalar(X,Y) _simd_u16x64_cmpne_scalar_(X,Y)
//	#define _simd_u16x64_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u16x64_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u16x64_cmpne_scalar(X,Y) _simd_u16x64_cmpne_safe(X,_simd_u16x64_fill_scalar_safe(Y))
//	#define _simd_u16x64_cmpne_scalar_enabled() true
//#endif
//
//// -- s8 --
//
...
//#else
//	#define _simd_s8x2_cmpne(X,Y) _simd_s8x2_combine(\
...
//
//
//#if defined(_simd_s8x2_cmpne_) && ! defined(_simd_s8x2_cmpne_scalar_)
//	#define _simd_s8x2_cmpne_scalar_(X,Y) _simd_s8x2_cmpne_(X,_simd_s8x2_fill_scalar_(Y))
//	#define _simd_s8x2_cmpne_scalar_instruction_set _simd_s8x2_cmpne_instruction_set
//#endif
//#ifdef _simd_s8x2_cmpne_scalar_
//	#define _simd_s8x2_cmpne_scalar(X,Y) _simd_s8x2_cmpne_scalar_(X,Y)
//	#define _simd_s8x2_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s8x2_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s8x2_cmpne_scalar(X,Y) _simd_s8x2_cmpne_safe(X,_simd_s8x2_fill_scalar_safe(Y))
//	#define _simd_s8x2_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_s8x1_cmpne_safe
//	#define _simd_s8x1_cmpne_safe(X,Y) static_cast<_simd_s8x1>(X != Y)
...
//#else
//	#define _simd_s8x4_cmpne(X,Y) _simd_s8x4_combine(\
...
//
//
//#if defined(_simd_s8x4_cmpne_) && ! defined(_simd_s8x4_cmpne_scalar_)
//	#define _simd_s8x4_cmpne_scalar_(X,Y) _simd_s8x4_cmpne_(X,_simd_s8x4_fill_scalar_(Y))
//	#define _simd_s8x4_cmpne_scalar_instruction_set _simd_s8x4_cmpne_instruction_set
//#endif
//#ifdef _simd_s8x4_cmpne_scalar_
//	#define _simd_s8x4_cmpne_scalar(X,Y) _simd_s8x4_cmpne_scalar_(X,Y)
//	#define _simd_s8x4_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s8x4_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s8x4_cmpne_scalar(X,Y) _simd_s8x4_cmpne_safe(X,_simd_s8x4_fill_scalar_safe(Y))
//	#define _simd_s8x4_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_s8x1_cmpne_safe
//	#define _simd_s8x1_cmpne_safe(X,Y) static_cast<_simd_s8x1>(X != Y)
...
//#else
//	#define _simd_s8x8_cmpne(X,Y) _simd_s8x8_combine(\
...
//
//
//#if defined(_simd_s8x8_cmpne_) && ! defined(_simd_s8x8_cmpne_scalar_)
//	#define _simd_s8x8_cmpne_scalar_(X,Y) _simd_s8x8_cmpne_(X,_simd_s8x8_fill_scalar_(Y))
//	#define _simd_s8x8_cmpne_scalar_instruction_set _simd_s8x8_cmpne_instruction_set
//#endif
//#ifdef _simd_s8x8_cmpne_scalar_
//	#define _simd_s8x8_cmpne_scalar(X,Y) _simd_s8x8_cmpne_scalar_(X,Y)
//	#define _simd_s8x8_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s8x8_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s8x8_cmpne_scalar(X,Y) _simd_s8x8_cmpne_safe(X,_simd_s8x8_fill_scalar_safe(Y))
//	#define _simd_s8x8_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_s8x1_cmpne_safe
//	#define _simd_s8x1_cmpne_safe(X,Y) static_cast<_simd_s8x1>(X != Y)
...
//#else
//	#define _simd_s8x16_cmpne(X,Y) _simd_s8x16_combine(\
...
//
//
//#if defined(_simd_s8x16_cmpne_) && ! defined(_simd_s8x16_cmpne_scalar_)
//	#define _simd_s8x16_cmpne_scalar_(X,Y) _simd_s8x16_cmpne_(X,_simd_s8x16_fill_scalar_(Y))
//	#define _simd_s8x16_cmpne_scalar_instruction_set _simd_s8x16_cmpne_instruction_set
//#endif
//#ifdef _simd_s8x16_cmpne_scalar_
//	#define _simd_s8x16_cmpne_scalar(X,Y) _simd_s8x16_cmpne_scalar_(X,Y)
//	#define _simd_s8x16_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s8x16_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s8x16_cmpne_scalar(X,Y) _simd_s8x16_cmpne_safe(X,_simd_s8x16_fill_scalar_safe(Y))
//	#define _simd_s8x16_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_s8x1_cmpne_safe
//	#define _simd_s8x1_cmpne_safe(X,Y) static_cast<_simd_s8x1>(X != Y)
...
//#else
//	#define _simd_s8x32_cmpne(X,Y) _simd_s8x32_combine(\
...
//
//
//#if defined(_simd_s8x32_cmpne_) && ! defined(_simd_s8x32_cmpne_scalar_)
//	#define _simd_s8x32_cmpne_scalar_(X,Y) _simd_s8x32_cmpne_(X,_simd_s8x32_fill_scalar_(Y))
//	#define _simd_s8x32_cmpne_scalar_instruction_set _simd_s8x32_cmpne_instruction_set
//#endif
//#ifdef _simd_s8x32_cmpne_scalar_
//	#define _simd_s8x32_cmpne_scalar(X,Y) _simd_s8x32_cmpne_scalar_(X,Y)
//	#define _simd_s8x32_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s8x32_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s8x32_cmpne_scalar(X,Y) _simd_s8x32_cmpne_safe(X,_simd_s8x32_fill_scalar_safe(Y))
//	#define _simd_s8x32_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_s8x1_cmpne_safe
//	#define _simd_s8x1_cmpne_safe(X,Y) static_cast<_simd_s8x1>(X != Y)
...
//#else
//	#define _simd_s8x64_cmpne(X,Y) _simd_s8x64_combine(\
...
//
//
//#if defined(_simd_s8x64_cmpne_) && ! defined(_simd_s8x64_cmpne_scalar_)
//	#define _simd_s8x64_cmpne_scalar_(X,Y) _simd_s8x64_cmpne_(X,_simd_s8x64_fill_scalar_(Y))
//	#define _simd_s8x64_cmpne_scalar_instruction_set _simd_s8x64_cmpne_instruction_set
//#endif
//#ifdef _simd_s8x64_cmpne_scalar_
//	#define _simd_s8x64_cmpne_scalar(X,Y) _simd_s8x64_cmpne_scalar_(X,Y)
//	#define _simd_s8x64_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_s8x64_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_s8x64_cmpne_scalar(X,Y) _simd_s8x64_cmpne_safe(X,_simd_s8x64_fill_scalar_safe(Y))
//	#define _simd_s8x64_cmpne_scalar_enabled() true
//#endif
//
//// -- u8 --
//
...
//#else
//	#define _simd_u8x2_cmpne(X,Y) _simd_u8x2_combine(\
...
//
//
//#if defined(_simd_u8x2_cmpne_) && ! defined(_simd_u8x2_cmpne_scalar_)
//	#define _simd_u8x2_cmpne_scalar_(X,Y) _simd_u8x2_cmpne_(X,_simd_u8x2_fill_scalar_(Y))
//	#define _simd_u8x2_cmpne_scalar_instruction_set _simd_u8x2_cmpne_instruction_set
//#endif
//#ifdef _simd_u8x2_cmpne_scalar_
//	#define _simd_u8x2_cmpne_scalar(X,Y) _simd_u8x2_cmpne_scalar_(X,Y)
//	#define _simd_u8x2_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u8x2_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u8x2_cmpne_scalar(X,Y) _simd_u8x2_cmpne_safe(X,_simd_u8x2_fill_scalar_safe(Y))
//	#define _simd_u8x2_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_u8x1_cmpne_safe
//	#define _simd_u8x1_cmpne_safe(X,Y) static_cast<_simd_u8x1>(X != Y)
...
//#else
//	#define _simd_u8x4_cmpne(X,Y) _simd_u8x4_combine(\
...
//
//
//#if defined(_simd_u8x4_cmpne_) && ! defined(_simd_u8x4_cmpne_scalar_)
//	#define _simd_u8x4_cmpne_scalar_(X,Y) _simd_u8x4_cmpne_(X,_simd_u8x4_fill_scalar_(Y))
//	#define _simd_u8x4_cmpne_scalar_instruction_set _simd_u8x4_cmpne_instruction_set
//#endif
//#ifdef _simd_u8x4_cmpne_scalar_
//	#define _simd_u8x4_cmpne_scalar(X,Y) _simd_u8x4_cmpne_scalar_(X,Y)
//	#define _simd_u8x4_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u8x4_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u8x4_cmpne_scalar(X,Y) _simd_u8x4_cmpne_safe(X,_simd_u8x4_fill_scalar_safe(Y))
//	#define _simd_u8x4_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_u8x1_cmpne_safe
//	#define _simd_u8x1_cmpne_safe(X,Y) static_cast<_simd_u8x1>(X != Y)
...
//#else
//	#define _simd_u8x8_cmpne(X,Y) _simd_u8x8_combine(\
...
//
//
//#if defined(_simd_u8x8_cmpne_) && ! defined(_simd_u8x8_cmpne_scalar_)
//	#define _simd_u8x8_cmpne_scalar_(X,Y) _simd_u8x8_cmpne_(X,_simd_u8x8_fill_scalar_(Y))
//	#define _simd_u8x8_cmpne_scalar_instruction_set _simd_u8x8_cmpne_instruction_set
//#endif
//#ifdef _simd_u8x8_cmpne_scalar_
//	#define _simd_u8x8_cmpne_scalar(X,Y) _simd_u8x8_cmpne_scalar_(X,Y)
//	#define _simd_u8x8_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u8x8_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u8x8_cmpne_scalar(X,Y) _simd_u8x8_cmpne_safe(X,_simd_u8x8_fill_scalar_safe(Y))
//	#define _simd_u8x8_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_u8x1_cmpne_safe
//	#define _simd_u8x1_cmpne_safe(X,Y) static_cast<_simd_u8x1>(X != Y)
...
//#else
//	#define _simd_u8x16_cmpne(X,Y) _simd_u8x16_combine(\
...
//
//
//#if defined(_simd_u8x16_cmpne_) && ! defined(_simd_u8x16_cmpne_scalar_)
//	#define _simd_u8x16_cmpne_scalar_(X,Y) _simd_u8x16_cmpne_(X,_simd_u8x16_fill_scalar_(Y))
//	#define _simd_u8x16_cmpne_scalar_instruction_set _simd_u8x16_cmpne_instruction_set
//#endif
//#ifdef _simd_u8x16_cmpne_scalar_
//	#define _simd_u8x16_cmpne_scalar(X,Y) _simd_u8x16_cmpne_scalar_(X,Y)
//	#define _simd_u8x16_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u8x16_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u8x16_cmpne_scalar(X,Y) _simd_u8x16_cmpne_safe(X,_simd_u8x16_fill_scalar_safe(Y))
//	#define _simd_u8x16_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_u8x1_cmpne_safe
//	#define _simd_u8x1_cmpne_safe(X,Y) static_cast<_simd_u8x1>(X != Y)
...
//#else
//	#define _simd_u8x32_cmpne(X,Y) _simd_u8x32_combine(\
...
//
//
//#if defined(_simd_u8x32_cmpne_) && ! defined(_simd_u8x32_cmpne_scalar_)
//	#define _simd_u8x32_cmpne_scalar_(X,Y) _simd_u8x32_cmpne_(X,_simd_u8x32_fill_scalar_(Y))
//	#define _simd_u8x32_cmpne_scalar_instruction_set _simd_u8x32_cmpne_instruction_set
//#endif
//#ifdef _simd_u8x32_cmpne_scalar_
//	#define _simd_u8x32_cmpne_scalar(X,Y) _simd_u8x32_cmpne_scalar_(X,Y)
//	#define _simd_u8x32_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u8x32_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u8x32_cmpne_scalar(X,Y) _simd_u8x32_cmpne_safe(X,_simd_u8x32_fill_scalar_safe(Y))
//	#define _simd_u8x32_cmpne_scalar_enabled() true
//#endif
//
//#ifndef _simd_u8x1_cmpne_safe
//	#define _simd_u8x1_cmpne_safe(X,Y) static_cast<_simd_u8x1>(X != Y)
...
//#else
//	#define _simd_u8x64_cmpne(X,Y) _simd_u8x64_combine(\
...
//
//
//#if defined(_simd_u8x64_cmpne_) && ! defined(_simd_u8x64_cmpne_scalar_)
//	#define _simd_u8x64_cmpne_scalar_(X,Y) _simd_u8x64_cmpne_(X,_simd_u8x64_fill_scalar_(Y))
//	#define _simd_u8x64_cmpne_scalar_instruction_set _simd_u8x64_cmpne_instruction_set
//#endif
//#ifdef _simd_u8x64_cmpne_scalar_
//	#define _simd_u8x64_cmpne_scalar(X,Y) _simd_u8x64_cmpne_scalar_(X,Y)
//	#define _simd_u8x64_cmpne_scalar_enable() anvil::simd::IsInstructionSetSupported<_simd_u8x64_cmpne_scalar_instruction_set>()
//#else
//	#define _simd_u8x64_cmpne_scalar(X,Y) _simd_u8x64_cmpne_safe(X,_simd_u8x64_fill_scalar_safe(Y))
//	#define _simd_u8x64_cmpne_scalar_enabled() true
//#endif
//
